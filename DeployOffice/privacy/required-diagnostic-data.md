...
- **contact_result_selected_count** - ติดตามจำนวนผลลัพธ์ที่ติดต่อที่ถูกเลือกระหว่างเซสชันการค้นหาแบบรวม

- **conversation_result_selected_count** - ติดตามจำนวนการสนทนาที่ถูกเลือกระหว่างเซสชันการค้นหาแบบรวม
...
- **Account** - ติดตามบัญชีและข้อมูลที่เกี่ยวข้องกับเหตุการณ์ ค่าที่ติดตามในข้อมูลนี้อยู่ในคู่มือเขตข้อมูลทั่วไป 
...
#### <a name="onenoteapponenoteappforeground-previous-name-officeonenoteandroidapponenoteappforeground"></a>OneNote.App.OneNoteAppForeground *(ชื่อก่อนหน้า)*, Office.OneNote.Android.App.OneNoteAppForeground
...
#### <a name="onenoteapplaunch-previous-name-officeandroidearlytelemetryapplaunch"></a>OneNote.AppLaunch *(ชื่อก่อนหน้า)*, Office.Android.EarlyTelemetry.AppLaunch
...
- **cid_type** - ระบุชนิดของบัญชีที่มี CID
