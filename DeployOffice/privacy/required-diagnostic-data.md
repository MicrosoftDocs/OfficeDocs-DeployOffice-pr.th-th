...
- **DeviceInfo.Id** - รหัสเฉพาะของอุปกรณ์ เพื่อช่วยให้เราตรวจหาปัญหาเฉพาะของอุปกรณ์

- **DeviceInfo.Make** - แบรนด์ของอุปกรณ์ (เช่น Apple, Samsung, และอื่นๆ) เพื่อช่วยให้เราตรวจหาปัญหาเฉพาะของแบรนด์อุปกรณ์

- **DeviceInfo.Model** - รุ่นอุปกรณ์ (เช่น iPhone 6s) เพื่อช่วยให้เราตรวจหาปัญหาเฉพาะของรุ่นอุปกรณ์
...
- **first_launch_date** - ระบุเวลาครั้งแรกที่เปิดใช้แอป ช่วยให้เราทราบเวลาที่ปัญหาเริ่มต้นขึ้นครั้งแรก
...
- **DeviceInfo.NetworkProvider** - ผู้ให้บริการเครือข่ายของอุปกรณ์ (เช่น Verizon)
...
- **office_session_id** - ID เฉพาะที่ติดตามเซสชันสำหรับบริการ Office ที่เชื่อมต่อ เพื่อช่วยตรวจหาปัญหาเฉพาะของการผสานรวมบริการ Office ใน Outlook เช่น Word
...
- **DeviceInfo.NetworkCost** - เครื่องหมายแสดงที่มาของเครือข่ายปัจจุบัน ซึ่งแสดงสถานะของ WiFi/เครือข่ายโทรศัพท์/โรมมิ่ง เพื่อช่วยตรวจหาปัญหาเฉพาะของเครือข่ายอุปกรณ์
...
- **action_origin** – จากตำแหน่งที่สร้างเหตุการณ์นี้ (เช่น ค่า: sso_drawer, sso_add_account, sso_add_account_prompt, sso_settings, sso_oobe)
...
#### <a name="onenoteapponenotelaunchednonactivated-previous-name-officeonenoteandroidapponenotelaunchednonactivated"></a>OneNote.App.OneNoteLaunchedNonActivated *(ชื่อก่อนหน้า)*, Office.OneNote.Android.App.OneNoteLaunchedNonActivated
...
#### <a name="onenoteresetstatus-previous-name-officeonenoteandroidresetstatus"></a>OneNote.ResetStatus *(ชื่อก่อนหน้า)*, Office.OneNote.Android.ResetStatus
...
#### <a name="onenotesigninsignincompleted-previous-name-officeonenoteandroidsigninsignincompleted"></a>OneNote.SignIn.SignInCompleted *(ชื่อก่อนหน้า)*, Office.OneNote.Android.SignIn.SignInCompleted
...
#### <a name="onenotesigninsigninstarted-previous-name-officeonenoteandroidsigninsigninstarted"></a>OneNote.SignIn.SignInStarted *(ชื่อก่อนหน้า)*, Office.OneNote.Android.SignIn.SignInStarted
...
- **action** - ชนิดการดำเนินการที่ทำ เช่น create_account, delete_account
...
- **result** - ผลลัพธ์ของการดำเนินการ เช่น สำเร็จ ล้มเหลว
...
- **action_type** - ชนิดของการดำเนินการที่ทำสำหรับการค้นหา ระบุว่าการค้นหาเริ่มต้นขึ้น กำลังดำเนินการ หรือสิ้นสุดแล้ว และระบุการดำเนินการที่เกิดขึ้นระหว่างการค้นหา เช่น มีการใช้ไมโครโฟน นี่คือเครื่องมือในการตรวจสอบการค้นหาที่แม่นยำและมีประโยชน์ 
...
- **result_selected_type** - ชนิดของข้อมูลที่แสดงคือชนิดที่ผู้ใช้โต้ตอบด้วย เช่น ดูที่ติดต่อ การสนทนา เหตุการณ์ทั้งหมด เป็นต้น 
...
- **search_origin** - ตำแหน่งเริ่มต้นของการค้นหา เช่น ตัวช่วยด้านเสียง, Cortana, การป้อนข้อมูลจากคีย์บอร์ด เป็นต้น 

- **search_scope** - สตริงที่ระบุชนิดของบัญชีที่ผู้ใช้กำลังค้นหา (เช่น Exchange, Gmail เป็นต้น) หรืออยู่ในบัญชีทั้งหมด 

- **search_suggestion_type** - ระบุเบื้องหลังของคำแนะนำการค้นหา เช่น เป็นการแก้ไขการสะกดหรือไม่ ยึดตามประวัติหรือไม่ ทำให้สมบูรณ์อัตโนมัติหรือไม่
...
- **action** - ชนิดของการดำเนินการที่ทำสำหรับการค้นหา ระบุว่าการค้นหาเริ่มต้นขึ้น กำลังดำเนินการ หรือสิ้นสุดแล้ว และระบุการดำเนินการที่เกิดขึ้นระหว่างการค้นหา เช่น มีการใช้ไมโครโฟน นี่คือเครื่องมือในการตรวจสอบการค้นหาที่แม่นยำและมีประโยชน์

- **answer_result_selected_count** - ติดตามจำนวนครั้งที่การค้นหา ”สำเร็จ” เช่น ผู้ใช้พบบุคคลที่พวกเขาต้องการหรือไม่ เขียนอีเมลหรือไม่ บุ๊กมาร์กข้อความหรือไม่ 
...
- **action** - ชนิดของการดำเนินการ เช่น บันทึก ละทิ้ง
 
- **draft_message_id** - รหัสข้อความของแบบร่าง

- **is_groups** - แบบร่างกำลังส่งถึง/จากโฟลเดอร์กลุ่มหรือไม่
 
- **origin** - ตำแหน่งที่เริ่มต้นแบบร่าง เช่น รายละเอียดข้อความ เขียน
...
- **attachment_extn** - นามสกุลไฟล์ของสิ่งที่แนบมาที่ดาวน์โหลด
...
- **duration** - ติดตามระยะเวลาที่ใช้ในการดำเนินการเป็นสตริงภาษาอังกฤษที่มนุษย์อ่านได้ (เช่น 1s, 4h)

- **error** - ข้อความแสดงข้อผิดพลาดที่เกี่ยวข้องกับการดำเนินการ 

- **event_mode** - ชนิดของโหมดเหตุการณ์ กลุ่มหรืออื่นๆ 

- **Extension** - นามสกุลของลิงก์หรือสิ่งที่แนบมาที่เกี่ยวข้องกับการดำเนินการนี้ 
...
- **message_type** - ระบุชนิดของข้อความ ชนิดของการดำเนินการที่ทำ** - กลุ่มหรืออื่นๆ
...
- **meeting_provider** - ระบุผู้ให้บริการสำหรับการประชุมออนไลน์ เช่น Teams, Skype for Business เพื่อช่วยเราตรวจหาปัญหาที่เกี่ยวข้องกับผู้ให้บริการการประชุมออนไลน์บางราย
...
- **Data_InitializationReason** - การแจงนับที่ระบุวิธีการเปิดไฟล์ เช่น องค์ประกอบ UI, ทริกเกอร์โดยแอปอื่น เป็นต้น
...
เหตุการณ์นี้ถูกรวบรวมไว้สำหรับแอปพลิเคชัน Office ที่ทำงานบน Android รวมถึง Office Mobile, Word, Excel, PowerPoint และ OneNote เหตุการณ์ระบุความพยายามในการลงชื่อเข้าใช้บัญชีองค์กรที่มีสิทธิการใช้งาน Intune ซึ่งผู้ดูแลระบบขององค์กรได้กำหนดค่านโยบายเพื่อบังคับใช้การเข้าถึงแบบมีเงื่อนไขของแอป ซึ่งใช้เพื่อทำความเข้าใจจำนวนผู้ใช้ที่พยายามใช้แอปภายใต้การกำหนดค่านโยบายนี้ และรวบกับเหตุการณ์อื่น Office_Android_Intune_IntuneComplianceStatus เพื่อให้มั่นใจมีการบังคับใช้ว่านโยบายที่กำหนดค่า 

ไม่ได้รวบรวมเขตข้อมูล

#### <a name="office_android_intune_intunecompliancestatus"></a>Office_Android_Intune_IntuneComplianceStatus

เหตุการณ์นี้ถูกรวบรวมไว้สำหรับแอปพลิเคชัน Office ที่ทำงานบน Android รวมถึง Office Mobile, Word, Excel, PowerPoint และ OneNote เหตุการณ์ระบุความพยายามในการลงชื่อเข้าใช้บัญชีองค์กรที่มีสิทธิการใช้งาน Intune ซึ่งผู้ดูแลระบบขององค์กรได้กำหนดค่านโยบายเพื่อบังคับใช้การเข้าถึงแบบมีเงื่อนไขของแอป เหตุการณ์นี้ระบุสถานะการปฏิบัติตามข้อบังคับของแอปพลิเคชันที่ผู้ใช้ลงชื่อเข้าใช้และใช้ในการตรวจสอบความล้มเหลว ซึ่งรวมกับเหตุการณ์อื่น Office_Android_Intune_IntuneComplianceRequest เพื่อให้มั่นใจว่ามีการบังคับใช้นโยบายที่กำหนดค่า
...
ระบบจะเก็บรวบรวมเหตุการณ์นี้ไว้สำหรับแอปพลิเคชัน Office ที่ทำงานบนแพลตฟอร์ม Android, iOS, Universal หรือ Windows ระบบจะบันทึกเหตุการณ์เมื่อมีการดำเนินการเกี่ยวกับไฟล์ (สร้าง/เปิด/บันทึก/นำออก/อื่นๆ) และมีการใช้การดำเนินดังกล่าวเพื่อทำความเข้าใจและจัดลำดับความสำคัญประสบการณ์ใช้งานของผู้ใช้ตามข้อมูลการดำเนินการเกี่ยวกับไฟล์
...
ระบบจะเก็บรวบรวมเหตุการณ์นี้ไว้สำหรับแอปพลิเคชัน Office ที่ทำงานบนแพลตฟอร์ม Android, iOS, Universal หรือ Windows ระบบจะบันทึกเหตุการณ์เมื่อมีการดำเนินการเปิดไฟล์จากเส้นทางที่ระบุไว้ในรายการที่ใช้งานล่าสุด และมีการใช้การดำเนินดังกล่าวเพื่อทำความเข้าใจและจัดลำดับความสำคัญข้อผิดพลาดในประสบการณ์ใช้งานของผู้ใช้ตามข้อมูลการดำเนินการเปิดไฟล์
...
ระบบจะเก็บรวบรวมเหตุการณ์นี้ไว้สำหรับแอปพลิเคชัน Office ที่ทำงานบนแพลตฟอร์ม Android, iOS, Universal หรือ Windows ระบบจะบันทึกเหตุการณ์เมื่อมีการดำเนินการเปิดไฟล์จาก URL ที่ระบุไว้ในรายการที่ใช้งานล่าสุด และมีการใช้การดำเนินดังกล่าวเพื่อทำความเข้าใจและจัดลำดับความสำคัญประสบการณ์ใช้งานของผู้ใช้ตามข้อมูลการดำเนินการเปิดไฟล์ 
...
ระบบจะเก็บรวบรวมเหตุการณ์นี้ไว้สำหรับแอปพลิเคชัน Office ที่ทำงานบนแพลตฟอร์ม Android, iOS, Universal หรือ Windows ระบบจะบันทึกเหตุการณ์เมื่อมีการดำเนินการเปิดไฟล์จากเส้นทางหนึ่ง และมีการใช้การดำเนินดังกล่าวเพื่อทำความเข้าใจและจัดลำดับความสำคัญประสบการณ์ใช้งานของผู้ใช้ตามข้อมูลการดำเนินการเปิดไฟล์
...
ระบบจะเก็บรวบรวมเหตุการณ์นี้ไว้สำหรับแอปพลิเคชัน Office ที่ทำงานบนแพลตฟอร์ม Android, iOS, Universal หรือ Windows ระบบจะบันทึกเหตุการณ์เมื่อมีการดำเนินการเปิดไฟล์จากแอปพลิเคชันอื่นโดยใช้ส่วนติดต่อตัวจัดการโพรโทคอล และมีการใช้การดำเนินดังกล่าวเพื่อทำความเข้าใจและจัดลำดับความสำคัญประสบการณ์ใช้งานของผู้ใช้ตามข้อมูลการดำเนินการเปิดไฟล์
...
ระบบจะเก็บรวบรวมเหตุการณ์นี้ไว้สำหรับแอปพลิเคชัน Office ที่ทำงานบนแพลตฟอร์ม Android, iOS, Universal หรือ Windows ระบบจะบันทึกเหตุการณ์เมื่อมีการดำเนินการเปิดไฟล์จากเชลล์ และมีการใช้การดำเนินดังกล่าวเพื่อทำความเข้าใจและจัดลำดับความสำคัญประสบการณ์ใช้งานของผู้ใช้ตามข้อมูลการดำเนินการเปิดไฟล์
...
ระบบจะเก็บรวบรวมเหตุการณ์นี้ไว้สำหรับแอปพลิเคชัน Office ที่ทำงานบนแพลตฟอร์ม Android, iOS, Universal หรือ Windows ระบบจะบันทึกเหตุการณ์เมื่อมีการดำเนินการเปิดไฟล์จาก URL หนึ่ง และมีการใช้การดำเนินดังกล่าวเพื่อทำความเข้าใจและจัดลำดับความสำคัญประสบการณ์ใช้งานของผู้ใช้ตามข้อมูลการดำเนินการเปิดไฟล์
...
- **Data_InitializationReason** - การแจงนับที่ระบุวิธีเปิดไฟล์ เช่น จากองค์ประกอบ UI หรือทริกเกอร์โดยแอปอื่น
...
- **type** - ชนิดของเหตุการณ์ที่บันทึก เช่น Trace, Error, Event, QoS
...
ติดตามเมื่ออุปกรณ์ที่มีสิทธิ์สำหรับแบบสำรวจจะเริ่มแอป ใช้เพื่อประเมินสถานภาพของกระบวนการการเลือกผู้ใช้ของแบบสำรวจ ตลอดจนตรวจสอบให้แน่ใจว่าสัญญาณที่ใช้ในการวิเคราะห์ปัญหาของลูกค้า และสถานภาพทำงานอย่างถูกต้อง
...
ติดตามเมื่อมีการเลือกอุปกรณ์สำหรับแบบสำรวจ ใช้เพื่อประเมินสถานภาพของกระบวนการการเลือกผู้ใช้ของแบบสำรวจ ตลอดจนตรวจสอบให้แน่ใจว่าสัญญาณที่ใช้ในการวิเคราะห์ปัญหาของลูกค้า และสถานภาพทำงานอย่างถูกต้อง
...
บนอุปกรณ์ Android ระบบจะติดตามเมื่อผู้ใช้บนอุปกรณ์โต้ตอบกับพร้อมท์แบบสำรวจและ UI แบบสำรวจ ใช้เพื่อประเมินสถานภาพของประสบการณ์ใช้งานแบบสำรวจแบบครอบคลุม ตลอดจนตรวจสอบให้แน่ใจว่าสัญญาณที่ใช้ในการวิเคราะห์ปัญหาของลูกค้า และสถานภาพทำงานอย่างถูกต้อง
...
บนอุปกรณ์ iOS ระบบจะติดตามเมื่อผู้ใช้บนอุปกรณ์โต้ตอบกับพร้อมท์แบบสำรวจและ UI แบบสำรวจ ใช้เพื่อประเมินสถานภาพของประสบการณ์ใช้งานแบบสำรวจแบบครอบคลุม ตลอดจนตรวจสอบให้แน่ใจว่าสัญญาณที่ใช้ในการวิเคราะห์ปัญหาของลูกค้า และสถานภาพทำงานอย่างถูกต้อง
...
บนอุปกรณ์ Mac ระบบจะติดตามเมื่อผู้ใช้บนอุปกรณ์โต้ตอบกับพร้อมท์แบบสำรวจและ UI แบบสำรวจ ใช้เพื่อประเมินสถานภาพของประสบการณ์ใช้งานแบบสำรวจแบบครอบคลุม ตลอดจนตรวจสอบให้แน่ใจว่าสัญญาณที่ใช้ในการวิเคราะห์ปัญหาของลูกค้า และสถานภาพทำงานอย่างถูกต้อง
...
บนอุปกรณ์ Win32 ระบบจะติดตามเมื่อผู้ใช้บนอุปกรณ์โต้ตอบกับพร้อมท์แบบสำรวจและ UI แบบสำรวจ ใช้เพื่อประเมินสถานภาพของประสบการณ์ใช้งานแบบสำรวจแบบครอบคลุม ตลอดจนตรวจสอบให้แน่ใจว่าสัญญาณที่ใช้ในการวิเคราะห์ปัญหาของลูกค้า และสถานภาพทำงานอย่างถูกต้อง
...
- **Data.clientType** - ชนิดของอุปกรณ์ที่ใช้งานแอป เช่น “Outlook_Win32”

- **Data.eventId** - ตัวระบุชื่อของเหตุการณ์ เช่น "LivePersonaCardRenderedAction"

- **Data.exportName** - ชื่อที่มนุษย์สามารถอ่านได้ของเหตุการณ์การดำเนินการของผู้ใช้ เช่น "ClosedExpandedPersonaCard"
...
- **Data.properties** - เมตาดาต้าเพิ่มเติมที่เก็บรวบรวมไว้สำหรับแต่ละเหตุการณ์ ดังนี้: *[เขตข้อมูลนี้ถูกนำออกจาก Office รุ่นปัจจุบันแล้ว แต่อาจยังปรากฏอยู่ในรุ่นที่เก่ากว่า]*
  ...
  - **cardCorrelationId** - ซ้ำกับ Data.appContextId ข้างต้น
  - **cardPersonaCorrelationId** - ซ้ำกับ Data.cardCorrelationId ข้างต้น
  - **consumerCorrelationId** - สำเนาของ Data.clientCorrelationId ข้างต้น
...
เหตุการณ์นี้จะถูกเก็บรวบรวมไว้สำหรับแอป Office สำหรับ iOS ซึ่งจะบันทึกเมื่อมีการดำเนินการเปิดไฟล์ เราเก็บรวบรวมข้อมูลนี้เพื่อให้แน่ใจว่าการทำงานสำหรับไฟล์ทั้งหมดที่เปิดในแอปมีประสิทธิภาพดี 

เขตข้อมูลต่อไปนี้จะถูกรวบรวม:

- **Data_Doc_ActivationFQDN** - ชื่อโดเมนของผู้ให้บริการแอปสำหรับสถานการณ์สมมติที่มีการเปิดใช้งานไฟล์ (เฉพาะข้อมูลแอพของบุคคลที่ 1 เท่านั้นที่จะถูกบันทึก)

- **Data_Doc_CreateTelemetryReason** – เหตุผลในการสร้าง PDF (เช่น: สร้างจากการสแกน, ใช้การดำเนินการ "รูปภาพเป็น pdf", ใช้การดำเนินการ "เอกสารเป็น pdf" เป็นต้น)
...
- **Data_Doc_Location** - ตำแหน่งของไฟล์ (Local, ODSP, iCloud, แอปไฟล์ของบุคคลที่สาม, wopi
...
- **Data_Doc_TelemetryReason** - เหตุผลการวัดและการส่งข้อมูลสำหรับการเปิดเหตุการณ์ (เช่น เปิดจาก MRU หรือเรียกดู การเปิดใช้งานไฟล์ การเปิดใช้งานโพรโทคอล และอื่นๆ)
...
- **Data_ProviderApp** - ผู้ให้บริการแอปในปัจจุบันในกรณีที่เปิดใช้งานไฟล์เท่านั้น 

- **Data_ReadOnly** - เครื่องหมายที่บอกว่าไฟล์เป็นแบบอ่านอย่างเดียวหรือไม่

- **Data_Result** - สถานะของการดำเนินการที่ทำอยู่ ตัวอย่างเช่น: true:สำเร็ต, false:ล้มเหลว
...
- **Data_Doc_URLHash** - GUID สำหรับ URL ของไฟล์ 
...
- **Data_Result** - สถานะของการดำเนินการที่ทำอยู่ (true:สำเร็ต, false:ล้มเหลว) 

- **Data_Type** - ชนิดการดำเนินการของไฟล์ (เปิด ปิด หรือบันทึก)


#### <a name="officeonenoteandroidappnavigationnavigationuistatechanged-onenoteappnavigationnavigationuistatechanged-previous-name"></a>Office.OneNote.Android.App.Navigation.NavigationUIStateChanged, OneNote.App.Navigation.NavigationUIStateChanged *(ชื่อก่อนหน้า)*
...
#### <a name="officeonenoteandroidlenssdkofficelenslaunched-onenotelenssdkofficelenslaunched-previous-name"></a>Office.OneNote.Android.LensSDK.OfficeLensLaunched, OneNote.LensSDK.OfficeLensLaunched *(ชื่อก่อนหน้า)*
...
#### <a name="onenotecanvaspageopened-previous-name-officeonenoteandroidcanvaspageopened"></a>OneNote.Canvas.PageOpened *(ชื่อก่อนหน้า)*, Office.OneNote.Android.Canvas.PageOpened
...
#### <a name="onenotecapturenewnotenewnotetaken-previous-name-officeonenoteandroidcapturenewnotenewnotetaken"></a>OneNote.Capture.NewNote.NewNoteTaken *(ชื่อก่อนหน้า)*, Office.OneNote.Android.Capture.NewNote.NewNoteTaken
...
#### <a name="onenotemessagebarmessagebarclicked-previous-name-officeonenoteandroidmessagebarmessagebarclicked"></a>OneNote.MessageBar.MessageBarClicked *(ชื่อก่อนหน้า)*, Office.OneNote.Android.MessageBar.MessageBarClicked
...
- **suggested_reply_types** - ระบุชนิดและจำนวนการตอบกลับที่แนะนำที่แสดง/ใช้สำหรับการสนทนานี้ ซึ่งเป็นพจนานุกรม ตัวอย่าง {text: 2, send_avail: 1}
...
เหตุการณ์นี้ช่วยให้เราติดตามปุ่มชนิดเอนทิตี (ทั้งหมด, จดหมาย, ที่ติดต่อ และปฏิทิน) ที่ผู้ใช้กำลังใช้งานเมื่อพวกเขาทำการค้นคว้า เพื่อให้พวกเราสามารถมั่นใจได้ว่ากลไกตัวกรองการค้นหาทำงานอย่างถูกต้อง

เขตข้อมูลต่อไปนี้จะมีการรวบรวม:

- **properties_general** -คุณสมบัติทั่วไปที่เหตุการณ์ Aria ทั้งหมดกำลังรวบรวม

- **selected_reason** - สาเหตุที่เลือกปุ่มชนิด ซึ่งอาจเป็นค่าใดค่าหนึ่งในสามค่านี้: tap_on_header, tap_on_see_all, enter_search_mode
...
- **suggested_reply_types** - ระบุชนิดและจำนวนการตอบกลับที่แนะนำที่แสดง/ใช้สำหรับอีเมลที่ส่งนี้ ซึ่งเป็นพจนานุกรม ตัวอย่าง {text: 2,  send_avail: 1}.

- **suggestions_requested** - ระบุจำนวนคำแนะนำเกี่ยวกับการเขียนแบบสมาร์ทที่ร้องขอ

- **suggestions_results** - ผลลัพธ์ของคำแนนำเกี่ยวกับการเขียนแบบสมาร์ท เช่น ได้รัการยอมรับ ถูกปฎิเสธ
...
- **setting_properties** - ติดตามความสัมพันธ์ของคุณสมบัติกับการดำเนินการตั้งค่า 

- **signature_setting** - ระบุว่าการตั้งค่าถูกนำไปใช้กับทุกบัญชีหรือบัญชีเดียว

- **source** - ระบุแหล่งของการแจ้งเตือน ถ้ามี จากการตั้งค่าหรือการตั้งค่าห้ามรบกวน

- **state_changed_to** - ตรวจสอบว่าการตั้งค่าเปิด/ปิดกล่องจดหมายเข้าที่โฟกัสของคุณได้รับการกำหนดค่าอย่างถูกต้องหรือไม่ 

- **swipe_action** - ตรวจสอบว่าคุณกำหนดค่าการดำเนินการปัดสำหรับการคัดกรองอีเมลเพื่อช่วยให้เรามั่นใจว่าการตั้งค่านี้ทำงานอย่างถูกต้อง 
...
- **swipe_setting** - ระบุรายละเอียดของการตั้งค่าการปัดที่เกี่ยวข้องกับการดำเนินการนี้ ถ้ามี
...
- **sidebar_type** - ติดตามชนิดของแถบด้านข้างที่เกี่ยวข้องกับเหตุการณ์นี้ เช่น จดหมายหรือปฏิทิน เพื่อช่วยให้เรามั่นใจว่าการนำทางจากการตั้งค่ารายการโปรดทำงานอย่างถูกต้อง
...
รวบรวมเขตข้อมูลต่อไปนี้:
  ...
  - **Data\_AppURL -** URL ของ Add-in, บันทึก URL แบบเต็มสำหรับ Add-in ที่จัดเก็บ และโดเมน URL สำหรับ Add-in ที่ไม่ได้จัดเก็บ
...
#### <a name="onenoteappappbootcomplete-previous-name-officeonenoteandroidappappbootcomplete-officeandroidearlytelemetryappbootcomplete"></a>OneNote.App.AppBootComplete *(ชื่อก่อนหน้า)*, Office.OneNote.Android.App.AppBootComplete, Office.Android.EarlyTelemetry.AppBootComplete
...
- **android.hardware.** - (เช่น android.hardware.bluetooth) ค่าการกำหนดค่าฮาร์ดแวร์ที่แพลตฟอร์ม Android ระบุไว้

- **android.software.** - (เช่น android.software.device_admin) ค่าการกำหนดค่าซอฟต์แวร์ที่แพลตฟอร์ม Android ระบุไว้
...
- **com.** (เช่น com.google.android.feature.FASTPASS_BUILD, com.amazon.feature.PRELOAD, com.samsung.android.bio.face) ค่าการกำหนดค่าเฉพาะผู้ผลิตที่แพลตฟอร์ม Android ระบุไว้
...
การใช้งาน: ใช้สำหรับคำนวณ “การเลือกใช้งาน” Microsoft 365 Apps for enterprise ส่วนกลางที่ไม่มีการใช้งานเฉพาะองค์กร สำหรับ add-in ซึ่งจะถูกใช้โดยเครื่องมือเช่น Readiness Toolkit ซึ่งช่วยให้ลูกค้าองค์กรสามารถตรวจสอบความถูกต้องว่า Add-in ที่พวกเขาปรับใช้ในองค์กรนั้นเข้ากันได้กับ Microsoft 365 Apps for enterprise เวอร์ชันล่าสุดหรือไม่ และวางแผนการอัปเกรดตามนั้น 
...
- **account_counter** - ติดตามจำนวนของบัญชีที่เกี่ยวข้องกับปฏิทินแต่ละชนิด เช่น 2 สำหรับปฏิทิน Gmail และระบุว่าบัญชีกำลังใช้บริการการซิงค์ใหม่ของเราหรือไม่

- **app_instance** – Outlook มีจุดเข้าใช้ 2 รายการสำหรับ Duo จุดหนึ่งสำหรับปฏิทินและอีกจุดหนึ่งสำหรับจดหมาย และจุดทั้งสองสามารถเปิดใช้งานแบบเคียงข้างกันในสภาพแวดล้อมของอินสแตนซ์ที่หลากหลายได้ ซึ่งจะบอกให้เราทราบว่าอินสแตนซ์ใดที่ทำให้การโทรรายงานนี้ ไม่ว่าจะเป็นจดหมายหรือปฏิทิน
...
เหตุการณ์นี้ช่วยให้เราสามารถตรวจหาและแก้ไขปัญหาที่เกิดผลกระทบด้านประสิทธิภาพที่เห็นได้ชัดกับคอมโพเนนต์ UI ของกล่องจดหมายเข้าของคุณ ซึ่งทำให้ข้อความอีเมล อวาตาร์ สถานะอ่าน/ยังไม่ได้อ่านโหลดหรือแสดงอย่างไม่ถูกต้อง
...
- **folder_type** - ชนิดของโฟลเดอร์ที่กำลังกรอง (เช่น กล่องจดหมายเข้า ขยะ ไม่ใช่ของระบบ)
...
เขตข้อมูลต่อไปนี้จะมีการรวบรวม:
  ...
  - **ColdBoot** - ครั้งแรกที่แอปพลิเคชัน Office ทำงานหลังจากการเริ่มระบบใหม่หรือแอปพลิเคชันไบนารีได้รับการโหลดจากดิสก์
...
เหตุการณ์นี้จะถูกทริกเกอร์ในช่วงหยุดของเซสชันทดสอบ ในการรวมกับ Office.PowerPoint.PPT.Android.RehearseView.StartSess นี่จะเป็นตัวบ่งชี้แรกของการหยุดทำงานหรือข้อผิดพลาดที่ผู้ใช้เผชิญ
...
เหตุการณ์จะถูกทริกเกอร์เมื่อเกิดข้อผิดพลาด เหตุการณ์นี้จะช่วยให้เราทราบข้อผิดพลาดที่ผู้ใช้เผชิญ และจะช่วยให้ Presenter Coach มีประสิทธิภาพการทำงานที่ดีบนอุปกรณ์เคลื่อนที่

เขตข้อมูลต่อไปนี้จะถูกรวบรวม:

- **Session id:string** – ID ของเซสชันทดสอบ

- **RehearsalEventCode: int** – รหัสข้อผิดพลาดของการทดสอบ
...
- **PageURL:string**- ข้อมูลนี้คือ URL ของหน้าที่เราสามารถใช้เพื่อระบุว่าเซสชันสำเร็จหรือมีข้อผิดพลาดบางอย่างเกิดขึ้น

- **Sessionid:string** - ข้อมูลนี้คือ ID เซสชัน FrontDoor การพูด เราสามารถใช้ข้อมูลนี้เพื่อแก้จุดบกพร่องของบันทึกบริการได้

- **SummaryPageLoadTime: int** – เวลา (ในหน่วย ms) ที่ใช้ในการโหลดหน้าสรุป ซึ่งรวมถึงเวลาการสร้าง Payload 
...
- **InitMediaCaptureLayerDurationInMs** – ข้อมูลนี้คือเวลาที่ใช้ในหน่วยมิลลิวินาทีในการเตรียมใช้งานชั้นการจับสื่อ/เสียง
...
สัญญาณสำคัญที่ใช้ติดตามการตอบกลับของผู้ใช้เมื่อเขา/เธอเห็นกล่องโต้ตอบการบูตที่ปลอดภัย กล่องโต้ตอบการบูตที่ปลอดภัยจะปรากฏเมื่อเราไม่สามารถเปิดใช้งานได้หลายครั้ง ตัวเลือกของผู้ใช้สำหรับการบูตที่ปลอดภัยจะถูกใช้เป็นสิทธิ์ในการล้างข้อมูลของแอปเพื่อให้เปิดใช้งานได้สำเร็จ ซึ่งใช้เพื่อให้มั่นใจว่ามีการตรวจหาการถดถอยที่สำคัญสำหรับแอป OneNote และสถานภาพของบริการ ผู้ใช้จะเห็นเมื่อพบข้อผิดพลาด่ร้ายแรงที่การบูตหยุดทำงาน ข้อมูลนี้จะช่วยติดตามว่ามีการแก้ปัญหาสาเหตุของการหยุดทำงานหรือยัง และผู้ใช้จะสามารถเปิดใช้แอปได้สำเร็จหรือไม่
...
#### <a name="onenotesyncprovisioningcompleted-previous-name-officeonenoteandroidsyncprovisioningcompleted"></a>OneNote.Sync.ProvisioningCompleted *(ชื่อก่อนหน้า)*, Office.OneNote.Android.Sync.ProvisioningCompleted
...
#### <a name="onenotesyncprovisioningstarted-previous-name-officeonenoteandroidsyncprovisioningstarted"></a>OneNote.Sync.ProvisioningStarted *(ชื่อก่อนหน้า)*, Office.OneNote.Android.Sync.ProvisioningStarted
...
ช่วยให้เราสามารถตรวจหาและแก้ไขสถานการณ์ที่การใช้หน่วยความจำของแอปและการใช้ CPU สูงขึ้นมาก ซึ่งอาจทำให้อุปกรณ์ของคุณช้าลง
...
- **type** - ชนิดของข้อผิดพลาดการยืนยันที่เกิดขึ้น เช่น null_folder_name, compose_selected_null_account เพื่อช่วยเราตรวจหาปัญหาที่เกี่ยวข้องกับส่วนเฉพาะของรหัส
...
- **error** - ชนิดของข้อผิดพลาด เช่น get_mailbox_location_failed
...
เอกสารสำคัญของ Android เท่านั้น (AppDocs) ข้อมูลรับส่งทางไกลสำหรับการดำเนินการสิ้นสุด การสร้างใหม่/เปิด/บันทึกเป็น ของไฟล์ ซึ่งจะจับรหัสข้อผิดพลาดสำหรับความล้มเหลวของ AppDocsOperations เหล่านี้  Microsoft ใช้วิธีนี้เพื่อระบุความล้มเหลวในการทำงานของไฟล์ต่างๆ และชั้นซึ่งเกิดความล้มเหลวได้อย่างถูกต้องใน Word, Excel, หรือ PowerPoint
...
จับข้อมูลสถานะการเปิดไฟล์และรหัสข้อผิดพลาดต่าง ๆ เพื่อระบุความล้มเหลวใดในการเปิดไฟล์ที่คาดการณ์ไว้กับที่ไม่คาดคิดและเป็นส่วนใดของรหัสที่รายงาน  Microsoft ใช้ข้อมูลนี้ในการวิเคราะห์หาเหตุผลของความล้มเหลวในการเปิดไฟล์ และคำนวณเมตริกที่สำคัญ เช่น อัตราความสำเร็จในการเปิดไฟล์ใน Word, Excel, หรือ PowerPoint
