...
- **Data.properties** - เมตาดาต้าเพิ่มเติมที่รวบรวมสำหรับแต่ละเหตุการณ์ดังต่อไปนี้:
   ...
   - **immersiveProfileCorrelationId** - รหัสเฉพาะสากลสำหรับเซสชันมุมมองโปรไฟล์ที่ขยาย
   - **personaCorrelationId** - รหัสเฉพาะสากลสำหรับ Persona เฉพาะในเซสชัน
...
- **Data.properties** - เมตาดาต้าเพิ่มเติมที่รวบรวมสำหรับแต่ละเหตุการณ์ดังต่อไปนี้:
  ...
  - **accountType** - ว่าผู้ใช้จะเป็นขององค์กรหรือผู้บริโภค
  ...
  - **contextType** - บริบท (แอป) ใดที่บัตรได้เปิดใช้

  - **ecsConfigIds** - ตัวระบุเวอร์ชันสำหรับฟีเจอร์ที่เปิดใช้งานในบัตร

  - **ecsTagId** - แท็ก ID สำหรับฟีเจอร์

  - **externalAppSessionCorrelationId** - รหัสเฉพาะสากลสำหรับแอปที่จะระบุบัตร Persona ทั้งหมดที่เปิดในเซสชันย่อยเดียวกัน

  - **flights** - ฟีเจอร์ที่เปิดใช้งานในบัตร

  - **fromCache** - ว่าข้อมูลถูกดึงมาจากหน่วยความจำหรือไม่

  - **hasFinePointer** - ว่าอุปกรณ์นั้นมีความสามารถของตัวชี้เมาส์หรือไม่

  - **hasHoverEvents** - ว่าอุปกรณ์นั้นมีความสามารถของโฮเวอร์เมาส์หรือไม่

  - **immersiveProfileCorrelationId** - รหัสเฉพาะสากลสำหรับเซสชันมุมมองโปรไฟล์ที่ขยาย

  - **offlineResolved** - ว่าข้อมูลถูกดึงมาในขณะออฟไลน์หรือไม่
...
- **Data.properties** - เมตาดาต้าเพิ่มเติมที่รวบรวมสำหรับแต่ละเหตุการณ์ดังต่อไปนี้:
  ...
  - **clientScenario** - เพื่อระบุฟีเจอร์ในแอปจากที่เปิดบัตร Persona

  - **consumerCorrelationId** - ซ้ำกับ Data.clientCorrelationId ข้างต้น 

  - **externalAppSessionCorrelationId** - ตัวระบุเฉพาะสำหรับแอปที่จะระบุบัตร Persona ทั้งหมดที่เปิดในเซสชันย่อยเดียวกัน

  - **hasPersonalInsightRing** - ผู้ใช้สามารถใช้ข้อมูลเชิงลึกจาก Office หรือ LinkedIn ได้

  - **immersiveProfileCorrelationId** - รหัสเฉพาะสากลสำหรับเซสชันมุมมองโปรไฟล์ที่ขยาย

  - **personaCorrelationId** - รหัสเฉพาะสากลสำหรับ Persona เฉพาะในเซสชัน

  - **section** – ส่วนที่ใช้งานอยู่ของบัตรแบบขยาย
...
ไม่ได้รวบรวมเขตข้อมูลเพิ่มเติม
