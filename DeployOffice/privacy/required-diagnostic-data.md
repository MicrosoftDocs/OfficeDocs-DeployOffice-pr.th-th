...
ในเหตุการณ์เริ่มต้นระบบที่บันทึกการจบการทำงานของแอปที่เหมาะสมและไม่เหมาะสมเพื่อตรวจสอบเพิ่มเติม

เขตข้อมูลต่อไปนี้จะมีการรวบรวม:

- **AffectedProcessResidentMemoryOnCrash** – หน่วยความจำในเครื่องของแอปที่หยุดทำงาน

- **AffectedProcessSessionID** – ID เซสชันของกระบวนการในการจบการทำงานครั้งถัดไป
...
- **AffectedSessionBuildNumber** – เวอร์ชันแอป

- **AffectedSessionDuration** – ระยะเวลาของเซสชันในหน่วยวินาทีก่อนที่จะหยุดทำงาน

- **AffectedSessionIDSMatch** – บูลีนสำหรับยืนยันว่า ID เซสชันการรายงานนั้นเป็นแบบเดียวกับที่เลือกโดย MERP

- **AffectedSessionLongBuildNumber** – หมายเลขบิลด์แบบยาว

- **AffectedSessionMERPSessionID** – ID เซสชันของ MERP

- **AffectedSessionOSLocale** – ตำแหน่งที่ตั้งของระบบปฏิบัติการ

- **AffectedSessionOSVersion** – เวอร์ชันของระบบปฏิบัติการ

- **AffectedSessionStackHash** – แฮชของการติดตามสแตกของแอปที่หยุดทำงาน

- **AffectedSessionStartTime** – วันที่เวลาที่เซสชันเริ่มต้น

- **AffectedSessionUAEType** – Enum จะมอบข้อมูลเกี่ยวกับชนิดของการหยุดทำงานที่เกิดขึ้น

- **AffectedSessionVersion** – เวอร์ชันแอป

- **DeviceModel** – รุ่นของฮาร์ดแวร์

- **ExitWasGraceful** – แอปก่อนหน้านี้จบการทำงานอย่างเหมาะสมหรือไม่
