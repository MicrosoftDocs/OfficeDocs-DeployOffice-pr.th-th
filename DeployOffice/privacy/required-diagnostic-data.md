...
สิทธิ์เป็นฟีเจอร์ที่มีความสำคัญ เนื่องจากถ้าไม่มีสิทธิ์ ผู้ใช้จะไม่สามารถใช้ฟีเจอร์ใดๆ ของ Lens ได้ มีการติดตามสิทธิ์เพื่อทำความเข้าใจพฤติกรรมของผู้ใช้ในการให้/เพิกถอนสิทธิ์ เมื่อผู้ใช้โต้ตอบกับกล่องโต้ตอบสิทธิ์ใดๆ ในแอปของเรา เราจะเก็บรวบรวมเหตุการณ์เหล่านี้ เราจะระบุการปรับปรุงฟีเจอร์เพื่อช่วยให้ผู้ใช้เข้าใจว่าเหตุใดสิทธิ์จึงมีความสำคัญจากแนวโน้มของผู้ใช้ในการยอมรับและปฏิเสธสิทธิ์

เขตข้อมูลต่อไปนี้จะมีการรวบรวม:

- **Data_action** - มีค่า เช่น “CameraPermissionAllowed (หรือ Denied), StoragePermissionGranted (หรือ Denied) ซึ่งช่วยให้เราเข้าใจว่าผู้ใช้ยอมรับหรือปฏิเสธสิทธิ์ของที่เก็บข้อมูลและกล้อง

- **Data_Action** - เขตข้อมูลนี้จะช่วยให้เราเข้าใจว่าผู้ใช้ขอสิทธิ์ประเภทใด เช่น กล้อง หรือที่เก็บข้อมูล

- **Data_status** - มีค่า เช่น Allowed, Denied และ DeniedForever ซึ่งช่วยให้เราเข้าใจว่าผู้ใช้ยอมรับหรือปฏิเสธสิทธิ์ของที่เก็บข้อมูลและกล้อง
...
เมื่อมีการอัปโหลดรูปไปยังบริการเสร็จเรียบร้อยแล้ว เหตุการณ์นี้จะถูกเก็บรวบรวม ซึ่งหมายความว่าบริการจะเรียกใช้งานตั้งแต่หนึ่งงานขึ้นไปเพื่อประมวลผลรูป และมี ID ที่เกี่ยวข้องเพื่อช่วยแก้ไขปัญหากระบวนการ นอกจากนี้ยังช่วยวิเคราะห์การใช้งานฟีเจอร์บริการต่างๆ

เขตข้อมูลต่อไปนี้จะมีการรวบรวม:

- **CloudConnectorRequestId** - สตริงที่ระบุคำขอรับบริการที่สร้างขึ้นเพื่อแปลงรูปผ่านบริการ

- **I2DserviceProcessID** - สตริงที่ระบุงานบริการที่ใช้คำขอย่อยเฉพาะ 
...
การวัดและส่งข้อมูลทางไกลทางวิศวกรรมที่สำคัญด้วย Microsoft Retail Federation Service (RFS) เพื่อรวบรวมข้อมูลที่ให้ไว้ในเหตุการณ์นี้ RFS ในบริการภายในที่ใช้ภายใน Microsoft สำหรับการตรวจสอบการซื้อ ข้อมุลจะถูกใช้เพื่อรับสถานภาพของการเรียก API ที่ทำกับ RFS ซึ่งจะช่วยให้เข้าใจอัตราความสำเร็จและการดีบักสำหรับความผิดพลาด

เขตข้อมูลต่อไปนี้จะมีการรวบรวม:

- **entryPoint** - สตริง – ปุ่ม/โฟลว์ที่จะแสดง Paywall เช่น “ปุ่มอัปเกรดพรีเมียม” หรือ “โฟลว์การเรียกใช้ครั้งแรก”

- **failureReason** - สตริง – เพิ่มเมื่อสถานะเป็น “ล้มเหลว” เท่านั้น ระบุการตอบสนองข้อผิดพลาดที่กำหนดโดยการตอบสนองการเตรียมใช้งาน RFS

- **productId** - สตริง – ID App Store ของผลิตภัณฑ์ที่มีการร้องขอ

- **status** - สตริง – สำเร็จหรือล้มเหลว ระบุว่าคำขอสำเร็จหรือล้มเหลว


#### <a name="officeiospaywallskuchooserbuybuttontap"></a>Office.iOS.Paywall.SKUChooser.BuyButtonTap

การวัดและส่งข้อมูลทางไกลสำหรับการใช้งานที่สำคัญที่จะระบุเมื่อผู้ใช้แตะปุ่มซื้อ/ซื้อ  ใช้ในการสรุปรูปแบบการใช้งานและเมตริกการแปลงสำหรับผู้ใช้ที่พยายามซื้อการสมัครใช้งานในแอป
...
การวัดและส่งข้อมูลทางไกลสำหรับการใช้งานเพื่อดูจํานวนครั้งที่ผู้ใช้สลับไปมาระหว่าง SKU ต่างๆ ก่อนที่จะทำการซื้อ
