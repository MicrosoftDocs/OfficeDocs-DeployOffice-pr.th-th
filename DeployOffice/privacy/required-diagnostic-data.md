...
- **account_creation_source** – คุณสมบัติเพิ่มเติมที่ใช้เพื่อค้นหาและวินิจฉัยปัญหาต่างๆ ที่เกิดขึ้นในระหว่างการสร้างบัญชีเมื่อชนิดของการดำเนินการเป็นการเพิ่ม  ซึ่งอาจมีค่าต่างๆ เช่น การลงชื่อเข้าระบบครั้งเดียว (SS0), create_new_account, manual และอื่นๆ

- **action** - ชนิดการดำเนินการที่ใช้กับบัญชีผู้ใช้ เช่น เพิ่ม ลบ หรือรีเซ็ต
...
- **Data_RestoredFailedPaymentCancelledFlowType** - รหัสแสดงประเภทของการยกเลิกการชำระเงินที่ดำเนินการ
...
เขตข้อมูลต่อไปนี้จะถูกรวบรวม:
  ...
  - **Data\_WinLaunchTime:integer -** เวลาที่ใช้ในการเปิดใช้งานบานหน้าต่างเริ่มต้นใช้งาน Visio ฯลฯ)
...
รวบรวมเขตข้อมูลต่อไปนี้:
  ...
  - **Data\_PreviousFailureHr -** ระบุว่าผลลัพธ์ที่ล้มเหลวครั้งล่าสุดคืออะไรในกรณีที่เปิดเอกสารเดียวกันอีกครั้ง
...
เหตุการณ์นี้จะช่วยติดตามประเภทของการใช้งานที่ผู้ใช้เห็นเมื่อผู้ใช้ดังกล่าวอยู่ในหน้าแอปพลิเคชันของเรา  ข้อมูลนี้จะใช้เพื่อกำหนดปริมาณการใช้งานของผู้ใช้สำหรับแต่ละการใช้งานในแอปพลิเคชันของเรา และยังช่วยให้เราสามารถรวบรวมผลลัพธ์การทดลองได้อย่างง่ายดาย
...
- **scenario** - ตำแหน่งที่ข้อผิดพลาดเกิดขึ้น แสดงขึ้น ก่อตัวขึ้น


## <a name="device-connectivity-and-configuration-data-events"></a>เหตุการณ์การเชื่อมต่ออุปกรณ์และข้อมูลการกำหนดค่า
