...
จากนั้น สัญญาณที่สำคัญที่ใช้เพื่อตรวจสอบให้มั่นใจว่าผู้ใช้ OneNote จะสามารถเปิดใช้แอปนี้ได้สำเร็จ
การวัดและส่งข้อมูลทางไกลถูกใช้เพื่อให้มั่นใจว่ามีการตรวจหาการถดถอยที่สำคัญสำหรับแอป OneNote และสถานภาพของบริการ ถ้าผู้ใช้ไม่สามารถเปิดใช้งานแอปในหน้าต่างประสิทธิภาพได้ อาจทริกเกอร์เหตุการณ์ที่มีความรุนแรงสูงได้
...
รวบรวมทุกครั้งที่การดำเนินการพิมพ์ PDF หรือส่งออก PDF นั้นเสร็จสิ้น และมีข้อมูลเกี่ยวกับชนิดเค้าโครง เช่นเดียวกับความสำเร็จของการดำเนินการ ข้อมูลนี้สำคัญต่อการระบุความสำเร็จของการดำเนินการพิมพ์ PDF และส่งออก PDF สำหรับแอปพลิเคชันของเรา
...
กิจกรรมที่สร้างขึ้นเมื่อ COM Add-in หยุดทำงาน  สิ่งนี้ใช้เป็นตัวเศษในการคำนวณของสถานะสถานภาพเฉพาะสำหรับองค์กรสำหรับ Add-in ที่ใช้ในการสรุประหว่างการทดสอบนำร่องว่า Add-in "พร้อมที่จะอัปเกรด" ในแวดวงการผลิตหรือไม่

เขตข้อมูลต่อไปนี้จะถูกรวบรวม (โปรดทราบว่าเขตข้อมูลเหล่านี้จะถูกเขียนเป็นพื้นที่ที่สำรองไว้เพื่อป้องกันการแยกสคริปต์ที่มีอยู่: AddinFriendlyName, AddinProgId, AddinVersion, AddinFileName)


- **AddinConnectFlag** - พฤติกรรมการโหลดปัจจุบัน

- **AddinFileName** - เขตข้อมูลว่างเปล่า - ไม่สนับสนุน

- **AddinFriendlyName** - เขตข้อมูลว่างเปล่า - ไม่สนับสนุน

- **AddinId** - ID ระดับของ Add-in

- **AddinProgId** - เขตข้อมูลว่างเปล่า - ไม่สนับสนุน

- **AddinTimeDateStamp** - การประทับเวลาของ Add-in จากเมตาดาต้า DLL

- **AddinVersion** - เขตข้อมูลว่างเปล่า - ไม่สนับสนุน
...
สัญญาณสำคัญที่ติดตามการโต้ตอบของผู้ใช้กับกล่องโต้ตอบ เข้าร่วม Office Insider โดยใช้เพื่อระบุปัญหาต่างๆ ในการดำเนินการเปลี่ยนแปลงโดยมีผู้ใช้เป็นผู้เริ่ม เช่น การเข้าร่วม/ออกจากโปรแกรม Office Insider และการเปลี่ยนระดับ Office Insider
