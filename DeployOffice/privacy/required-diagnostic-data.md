...
เหตุการณ์นี้จะถูกรวบรวมไว้สำหรับแอปพลิเคชัน Office ที่ทำงานบนแพลตฟอร์ม Android, iOS, Universal หรือ Windows ระบบจะบันทึกเหตุการณ์เมื่อมีการดำเนินการเกี่ยวกับไฟล์ (สร้าง/เปิด/บันทึก/นำออก/อื่นๆ) และมีการใช้การดำเนินดังกล่าวเพื่อทำความเข้าใจและจัดลำดับความสำคัญประสบการณ์ใช้งานของผู้ใช้ตามข้อมูลการดำเนินการเกี่ยวกับไฟล์
...
สัญญาณสำคัญที่ใช้ติดตามการตอบกลับของผู้ใช้เมื่อผู้ใช้เห็นกล่องโต้ตอบการบูตที่ปลอดภัย กล่องโต้ตอบการบูตที่ปลอดภัยจะปรากฏเมื่อเราไม่สามารถเปิดใช้งานได้หลายครั้ง ตัวเลือกของผู้ใช้สำหรับการบูตที่ปลอดภัยจะถูกใช้เป็นสิทธิ์ในการล้างข้อมูลของแอปเพื่อให้เปิดใช้งานได้สำเร็จ ซึ่งใช้เพื่อให้มั่นใจว่ามีการตรวจหาการถดถอยที่สำคัญสำหรับแอป OneNote และสถานภาพของบริการ ผู้ใช้จะเห็นเมื่อพบข้อผิดพลาด่ร้ายแรงที่การบูตหยุดทำงาน ข้อมูลนี้จะช่วยติดตามว่ามีการแก้ปัญหาสาเหตุของการหยุดทำงานหรือยัง และผู้ใช้จะสามารถเปิดใช้แอปได้สำเร็จหรือไม่
