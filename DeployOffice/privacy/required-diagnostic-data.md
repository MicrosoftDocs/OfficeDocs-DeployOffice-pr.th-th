...
- **origin_view** - มุมมองแหล่งข้อมูลของการดำเนินการ เช่น การสนทนา ข้อความ เป็นต้น
...
- **Data_LinkType** - สตริงที่กำหนดค่าตายตัวที่อธิบายถึงประเภทของการดำเนินงานการเชิญที่ดำเนินการเหมือนกับ "ViewOnly" และ "ViewAndEdit"
...
- **runtime_performance_monitoring_data** - ให้ข้อมูลประสิทธิภาพการทำงาน (เวลาในการโหลด การนับจำนวนระเบียน) เมื่อโหลดข้อมูลในส่วนต่างๆของแอป
  ...
  - **scope** - แสดงชื่อของหน้า UI หรือคอมโพเนนต์ที่เป็นของเหตุการณ์นี้
