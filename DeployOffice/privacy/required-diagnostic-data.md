...
รวบรวมข้อมูลการติดตั้งสำหรับ Add-in ของ Office ที่กำหนด Ribbon เอง  โดยใช้เพื่อตรวจหาปัญหาเกี่ยวกับวิธีที่ Add-in แบบกำหนดเองปรับเปลี่ยน Ribbon ของ Office
...
เหตุการณ์นี้จะบันทึกสถิติเอกสารของทุกเอกสาร เมื่อ Office Word ปิดลงหรือหยุดทำงาน  โดยจะใช้เหตุการณ์เพื่อเชื่อมโยงการแก้ไขเอกสาร ขนาด และข้อมูลอื่นๆ พร้อมกับข้อผิดพลาดในการบันทึกเอกสาร การแชร์เอกสาร และการทำงานร่วมกันแบบออนไลน์ในเอกสาร

เขตข้อมูลต่อไปนี้จะมีการรวบรวม:

- **Data_BkmkRefCount** - จำนวนการอ้างอิงบุ๊กมาร์กในเอกสาร

- **Data_CharacterCount** - จำนวนอักขระในเอกสาร

- **Data_CharactersWithSpaceCount** - จำนวนอักขระและช่องว่างในเอกสาร

- **Data_ChartCount** - จำนวนแผนภูมิในเอกสาร

- **Data_CitationCount** - จำนวนข้อมูลอ้างอิงในเอกสาร

- **Data_DocumentLocation** - ระบุว่า บริการใดที่ให้เอกสาร (OneDrive, File Server, SharePoint เป็นต้น)

- **Data_ETW_TrackbackTag** - ระบุตำแหน่งในรหัสที่ปิดเหตุการณ์ (ปิดหรือหยุดทำงาน)

- **Data_EndnoteDocCount** - จำนวนบรรณานุกรมในเอกสาร

- **Data_FootnoteDocCount** - จำนวนเชิงอรรถในเอกสาร

- **Data_HasBibliography** - ระบุว่าเอกสารมีบรรณานุกรมหรือไม่

- **Data_HasHeader** - ระบุว่าเอกสารมีส่วนหัวหรือไม่

- **Data_IsImeUsed** - ระบุว่ามีการใช้ตัวแก้ไขวิธีการป้อนข้อมูลในเอกสารหรือไม่

- **Data_IsPageCountInProgress** - ระบุว่ากำลังดำเนินการนับหน้าในเอกสารหรือไม่
    
- **Data_IsTouchUsed** - ระบุว่ามีการใช้การป้อนข้อมูลด้วยการสัมผัสในเอกสารหรือไม่

- **Data_IsTrackChangesOn** - ระบุว่ามีการใช้การติดตามการเปลี่ยนแปลงในเอกสารหรือไม่

- **Data_LineCount** - จำนวนบรรทัดในเอกสาร

- **Data_MainPdod** - ตัวระบุเอกสารในกระบวนการ Office Word

- **Data_PageCount** - จำนวนหน้าในเอกสาร

- **Data_PageNumberFieldCount** - จำนวนเขตข้อมูลหมายเลขหน้าในเอกสาร

- **Data_ParagraphCount** - จำนวนย่อหน้าในเอกสาร

- **Data_PicCount** - จำนวนรูปภาพในเอกสาร

- **Data_RsidCount** - จำนวนตัวระบุการบันทึกการแก้ไขในเอกสาร

- **Data_TocCount** - จำนวนสารบัญในเอกสาร

- **Data_UrlHash** - แฮชแบบทางเดียวเพื่อสร้างตัวระบุเอกสาร Naïve

- **Data_UserActionID** - ไม่ใช้เขตข้อมูลนี้ (ค่าจะเป็น 0 เสมอ)

- **Data_UserActionName** - เป็น "DocumentStatsOnCloseAndSuspend" เสมอ

- **Data_UserInteractionTimeMsec** - จำนวนมิลลิวินาทีที่ผู้ใช้ใช้งานเอกสาร
    
- **Data_WordCount** - จำนวนคำในเอกสาร
...
เหตุการณ์นี้ระบุว่า Office Word บันทึกเอกสารที่กู้คืนอัตโนมัติ ซึ่งยังไม่ได้บันทึกมาก่อน ซึ่งช่วยให้ Microsoft สามารถตรวจหาข้อผิดพลาดในการกู้คืนอัตโนมัติ ซึ่งสำคัญต่อความปลอดภัยของข้อมูลในเอกสาร  เหตุการณ์จะตรวจสอบว่าการบันทึกการกู้คืนอัตโนมัติทำงานตามที่คาดไว้หรือไม่ นอกจากนี้ยังใช้คำนวณเมตริกความน่าเชื่อถือของระบบคลาวด์และอุปกรณ์/ผู้ใช้ที่ใช้งานอยู่รายเดือน
...
- **Data_FailureClass** - จำนวนเต็มที่แสดงถึงระดับความล้มเหลวของความล้มเหลวในการถ่ายโอนไปยังบริการการทำงานร่วมกันของ Office (OCS)
...
การใช้งาน: สิ่งนี้ใช้ในการคำนวณ "การเริ่มนำไปใช้" ของ Office 365 ProPlus ส่วนกลางที่ไม่เฉพาะเจาะจงสำหรับองค์กรสำหรับ Add-in ซึ่งจะเผยแพร่ใน readyforwindows.com และเครื่องมืออื่นๆ เช่น Readiness Toolkit ซึ่งช่วยให้ลูกค้าองค์กรสามารถตรวจสอบความถูกต้องว่า Add-in ที่พวกเขาปรับใช้ในองค์กรนั้นเข้ากันได้กับ Office 365 ProPlus เวอร์ชันล่าสุดหรือไม่ และวางแผนการอัปเกรดตามนั้น 
