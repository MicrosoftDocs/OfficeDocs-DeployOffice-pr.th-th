...
ประเภทนี้มีเขตข้อมูลต่อไปนี้:
  ...
  - **IsDebug** - สัญลักษณ์ที่ระบุว่ารุ่นของ Office เป็นรุ่นแก้จุดบกพร่องหรือไม่ ช่วยให้เราระบุได้ว่าปัญหามาจากรุ่นแก้จุดบกพร่อง ซึ่งอาจทำงานแตกต่างกันหรือไม่
...
การใช้งานการวัดและส่งข้อมูลทางไกลที่สำคัญนี้จะรวบรวมเมื่อการควบคุม Paywall แสดงต่อผู้ใช้และใช้เพื่อทำความเข้าใจประสบการณ์การซื้อในแอปสำหรับผู้ใช้และปรับให้เหมาะสมสำหรับเวอร์ชันในอนาคต
...
เมตาดาต้าที่ยึดตามเซสชันนี้ถูกรวบรวมเมื่อ Paywall UI แสดงต่อผู้ใช้ ระยะเวลาของการโต้ตอบ และความพยายามในการซื้อสำเร็จหรือล้มเหลว  ข้อมูลนี้ใช้เพื่อทำความเข้าใจการใช้งานและความสมบูรณ์ของประสบการณ์การชำระเงินและแก้จุดบกพร่อง เพิ่มประสิทธิภาพและแก้ไขปัญหาประสบการณ์การซื้อในแอปในเวอร์ชันอนาคต
...
เหตุการณ์นี้รวบรวมฟีเจอร์และแอปที่ผู้ใช้ขยายจาก "ดูสิทธิประโยชน์เพิ่มเติม" และระยะเวลาที่ใช้  ข้อมูลที่ใช้เพื่อทําความเข้าใจการใช้งานฟีเจอร์ "ดูประโยชน์ทั้งหมด" และเพิ่มประสิทธิภาพประสบการณ์ในเวอร์ชันในอนาคต
...
การใช้การวัดและส่งข้อมูลทางไกลจะถูกรวบรวมเพื่อดูว่าผู้ใช้ป้อน SKU Chooser อย่างไร ผู้ใช้ใช้เวลาบนหน้าจอ SKU Chooser นานเท่าใดและเหตุใดจึงออกจาก SKU Chooser  ข้อมูลถูกใช้เพื่อทำความเข้าใจการใช้งาน SKU Chooser และเพิ่มประสิทธิภาพประสบการณ์การซื้อในแอปในเวอร์ชันอนาคต

มีการรวบรวมเขตข้อมูลต่อไปนี้:

- **entryPoint** - สตริง – ปุ่ม/โฟลว์ ที่ Paywall ถูกแสดง เช่น "ปุ่มอัปเกรดพรีเมียม" หรือ "โฟลว์การเรียกใช้ครั้งแรก"

- **exitReason** - สตริง – เหตุผลที่ออกจาก SKU Chooser เช่น “ปุ่มซื้อ”, “ปุ่มปิด
...
- **action** - การดำเนินการ เช่น การดูที่ติดต่อ
...
การใช้การวัดและส่งข้อมูลทางไกลจะถูกรวบรวมเพื่อทราบเมื่อการจัดซื้อ / การจัดเตรียม / การเปิดใช้งานล้มเหลว และผู้ใช้แตะปุ่ม "ลองอีกครั้ง"  ใช้เพื่อแก้ไขสถานการณ์ข้อผิดพลาดในการซื้อที่นำไปสู่การลองใหม่และปรับปรุงความน่าเชื่อถือของกระบวนการ

มีการรวบรวมเขตข้อมูลต่อไปนี้:

- **failureReason** - สตริง –ระบุความล้มเหลวที่ผู้ใช้กำลังลองใหม่ เช่น “การจัดเตรียมล้มเหลว”,“ การซื้อล้มเหลว”,“ การเปิดใช้งานล้มเหลว”
...
เหตุการณ์นี้ใช้ บัญชี Microsoft (MSA) เพื่อกําหนดว่าผู้ใช้รายใดพยายามลงชื่อเข้าใช้แอป และในระหว่างนั้นการวัดและส่งข้อมูลทางไกลที่กำลังสนทนาจะถูกทริกเกอร์เป็นส่วนหนึ่งของความพยายามที่ไม่ประสบความสำเร็จ  
