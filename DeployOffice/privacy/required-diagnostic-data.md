...
- **exrule** - ค่าของกฎเพิ่มเติม (ใช้กับข้อผิดพลาดกิจวัตรของการนัดหมายเท่านั้น)

- **exdate** - วันที่ของกฎเพิ่มเติม (ใช้กับข้อผิดพลาดกิจวัตรของการนัดหมายเท่านั้น)
...
- **rdate** - วันที่ของกฎกิจวัตร (ใช้กับข้อผิดพลาดกิจวัตรของการนัดหมายเท่านั้น) 

- **rrule** - กฎกิจวัตร (ใช้กับข้อผิดพลาดกิจวัตรของการนัดหมายเท่านั้น) 

- **rrule_error_message** - กฎกิจวัตรที่แยกวิเคราะห์ข้อความแสดงข้อผิดพลาด (ใช้กับข้อผิดพลาดกิจวัตรของการนัดหมายเท่านั้น)

- **rrule_error_type** - กฎกิจวัตรที่แยกวิเคราะห์ชนิดข้อผิดพลาด (ใช้กับข้อผิดพลาดกิจวัตรของการนัดหมายเท่านั้น)
...
เหตุการณ์นี้จะถูกเก็บรวบรวมไว้สำหรับ Union iOS ซึ่งจะบันทึกเมื่อมีการดำเนินการเปิดไฟล์ เราเก็บรวบรวมข้อมูลนี้เพื่อให้แน่ใจว่าการทำงานสำหรับไฟล์ทั้งหมดที่เปิดในแอปมีประสิทธิภาพดี 
