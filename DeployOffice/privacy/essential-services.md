...
- **Microsoft_ADAL_error_domain** - โดเมน/คอมโพเนนต์ที่สร้างโดยรหัสข้อผิดพลาด
...
- **Microsoft_ADAL_is_successfull** - True/false ที่บอกว่า API ของ ADAL สำเร็จหรือไม่
...
- **MSAL_auth_flow_last_error** - รหัสข้อผิดพลาดที่เราได้รับจากเซิร์ฟเวอร์ในรายการที่ 2 ถึงสุดท้ายใน AuthFlow (เช่น ถ้า AuthFlow = "PRT|LRT" ข้อผิดพลาดของ PRT จะเป็น AuthFlowLastError)
...
- **Platform** - แพลตฟอร์มระบบปฏิบัติการ (0: Windows Desktop, 1: Android, 2: iOS, 3: MacOS, 4: UWP)
...
- **Scenarioid** - เหตุการณ์หลายเหตุการณ์อาจอยู่ในสถานการณ์เดียว เช่น สถานการณ์อาจเป็นการเพิ่มบัญชีใหม่ แต่มีพร้อมท์หลายรายการที่เกิดขึ้นเป็นส่วนหนึ่งของสถานการณ์ดังกล่าว ตัวระบุนี้เปิดใช้งานความสัมพันธ์ของเหตุการณ์ที่เกี่ยวข้องเหล่านั้น

- **Scenarioname** - ชื่อของสถานการณ์ของแอปพลิเคชันที่จําเป็นต้องมีการรับรองความถูกต้อง เช่น การเริ่มต้นระบบครั้งแรก การตรวจสอบการอนุญาตให้ใช้สิทธิ์ เป็นต้น
...
- **oneauth_transactionuploadid** - ระบุ GUID ภายในที่สร้างขึ้นแบบสุ่มที่แมปกับการเรียกใช้ API ของ OneAuth API เฉพาะ
...
- **BitField –**    ค่าจำนวนเต็มของอาร์กิวเมนต์ BitField ซึ่งบอกเราว่ามีการขอตัวเลือกการติดตั้ง/อัปเดตอย่างชัดเจนหรือไม่ ตัวอย่างเช่น ตัวเลือกรุ่นเบต้า, ตัวเลือกปัจจุบัน (พรีวิว), ตัวเลือกปัจจุบัน, ตัวเลือกระดับองค์กรรายเดือน, ตัวเลือกระดับองค์กรรายครึ่งปี (พรีวิว) หรือ ตัวเลือกระดับองค์กรรายครึ่งปี
...
- **CMDMode –**    สตริงที่เข้าใจง่ายซึ่งสอดคล้องกับสวิตช์โหมดโดยรวมถูกตรวจพบในอาร์กิวเมนต์ cmd ที่ส่งผ่านไปยัง exe
...
- **MostExplored** - จำนวนเต็มแสดงถึงดัชนีของรายการที่มีการสลับมากที่สุดในรายการแอป M365 และคุณสมบัติต่างๆ
...
การวัดและส่งข้อมูลทางไกลสำหรับการใช้งานที่สำคัญจะถูกรวบรวมเพื่อระบุเมื่อผู้ใช้แตะปุ่มซื้อ / ซื้อ  ข้อมูลนี้ใช้ในการสรุปรูปแบบการใช้งานและเมตริกการแปลงสำหรับผู้ใช้ที่พยายามซื้อการสมัครใช้งานในแอป
...
- **InAFOFlow** - บูลีนที่บ่งชี้ว่าเราอยู่ในขั้นตอนการแลกใช้ AFO หรือไม่
...
- **DialogRedemption** - สัญญาณว่าเราแสดงกล่องโต้ตอบการแลกใช้ AFO

- **DialogSignIn** - สัญญาณว่าเราแสดงกล่องโต้ตอบการลงชื่อเข้าใช้ AFO
...
- **Tag** - บอกเราเกี่ยวกับขั้นตอนที่ผู้ใช้สิ้นสุดกระบวนการแลกใช้ AFO แท็กที่เป็นไปได้:
    ...
    - 0x2370e3a3      ผู้ใช้คลิกไฮเปอร์ลิงก์ "ไม่ใช่ตอนนี้" ซึ่งข้ามข้อเสนอ AFO สำหรับเซสชันดังกล่าว
    - 0x2370e3a2      ผู้ใช้คลิกที่ไฮเปอร์ลิงก์ "ไม่ต้องแสดงสิ่งนี้กับฉัน" ซึ่งปิดใช้งานข้อเสนอ AFO
...
- **UseModernAFO** - บอกให้ทราบว่าเรากำลังใช้ประสบการณ์ AFO ใหม่หรือเก่าอยู่
...
เหตุการณ์นี้บ่งชี้ว่าเริ่มต้นงานการโคลนก่อนการอัปเดตแอปพลิเคชัน เราใช้เหตุการณ์นี้ร่วมกับเหตุการณ์ cloningtask_status เพื่อกำหนดปริมาณของความล้มเหลวในการโคลนเพื่อตรวจสอบว่าฟีเจอร์การโคลนควรถูกเร่งในแชนเนลผู้ชมที่ต่างออกไปหรือไม่
...
- **UpdateURL** -URL ของแพคเกจการอัปเดตที่จำเป็นในการนำไปใช้
...
- **ChannelName** - แชนเนลที่กล่องโต้ตอบการยินยอมจะปรากฏขึ้นสำหรับ
...
- **AppID** - ตัวระบุแอปพลิเคชันที่ส่ง API ของส่วนติดต่อผู้ใช้สำหรับบรรทัดคำสั่งไปยัง MAU
...
- **EventType** - ประเภทของเหตุการณ์ที่ส่งโดยแอปพลิเคชันไปยัง API ส่วนติดต่อผู้ใช้สำหรับบรรทัดคำสั่งของ MAU
...
ถ้าเราเห็นเวลาแฝงที่ยอมรับไม่ได้สำหรับส่วนหรือสมุดบันทึก เราจะใช้ข้อมูลนี้ในการเชื่อมโยงกับสัญญาณอื่นๆ จากไคลเอ็นต์และบริการตามเอกสารเดียวกันเพื่อระบุการถดถอยของประสิทธิภาพการทำงานของไคลเอ็นต์ ซึ่งจะช่วยให้เราสามารถให้การบริการที่มีประสิทธิภาพมากขึ้นได้
...
การวัดและส่งข้อมูลทางไกลของผลิตภัณฑ์ที่ใช้สำหรับการกระทบยอดข้อมูลทรานแซคชันการซื้อกับระบบการค้าของ Microsoft เพื่อเปิดใช้ประโยชน์การสมัครสมาชิกที่เกี่ยวข้อง ใช้เพื่ออำนวยความสะดวกในการบันทึกทรานแซคชันและการจัดเตรียมการสมัครสมาชิกสำหรับการอ้างอิงในอนาคตและการกระทบยอดภายใน
...
ข้อมูลจะถูกรวบรวมเป็นการวัดและส่งข้อมูลทางไกลทางวิศวกรรมที่สำคัญเพื่อบันทึกผลลัพธ์ของความพยายามในการซื้อที่เรียกด้วยตนเองโดยผู้ใช้ การวัดและส่งข้อมูลทางไกลของผลิตภัณฑ์ใช้สำหรับการกระทบยอดข้อมูลทรานแซคชันการซื้อกับระบบการค้าของ Microsoft เพื่อเปิดใช้ประโยชน์การสมัครสมาชิกที่เกี่ยวข้อง
...
เขตข้อมูลต่อไปนี้จะมีการรวบรวม:
  ...
  - **AddinExecution-** ค่าสถานะที่จะแจ้งให้ทราบว่ามีการดำเนินการ Add-in ที่ยังไม่เสร็จสิ้นในระหว่างการออกจากแอปพลิเคชันอย่างไม่เหมาะสม

  - **BootCompleted –** Office บูตเสร็จสมบูรณ์เมื่อหยุดทำงานหรือไม่
  ...
  - **CrashTime –** เวลาที่ระบุว่าไคลเอ็นต์สิ้นสุดโดยไม่คาดคิด
  ...
  - **HandOff –** ผู้ใช้สร้างและส่งกระบวนการของ Office ไปยังเซสชันใหม่หรือไม่

  - **HasEdit –** ผู้ใช้แก้ไขเอกสารในไคลเอ็นต์ที่หยุดทำงานหรือไม่

  - **HasOpen –** เอกสารเปิดในไคลเอ็นต์ที่หยุดทำงานหรือไม่
  ...
  - **PreviousBuild -** เวอร์ชันของรุ่นที่ติดตั้งไว้ก่อนหน้านี้

  - **SafeMode –** เซสชันบูตในเซฟโหมดหรือไม่
