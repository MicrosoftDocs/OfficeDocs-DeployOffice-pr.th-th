...
|[Microsoft AutoUpdate (MAU)](#microsoft-autoupdate-mau-events)|Microsoft AutoUpdate (MAU) เป็นเทคโนโลยีที่ใช้ในการอัปเดตแอปพลิเคชันของ Microsoft ที่สร้างขึ้นสำหรับ MacOS เช่น Office MAU จะตรวจหาความจำเป็น ดาวน์โหลด และติดตั้งการอัปเดตแอปพลิเคชัน รวมถึงการอัปเดตเกี่ยวกับความปลอดภัย|
...
รายงานเกี่ยวกับสถานะสำหรับไปป์ไลน์การอัปเดตคลิก-ทู-รันแบบใหม่ ("Repoman") ถ้าการดาวน์โหลดสำเร็จและนำไปใช้กับการอัปเดตของ Office ได้อย่างสมบูรณ์
...
- **BytesFromGroupPeers -** ไบต์จากเพียร์กลุ่ม เฉพาะสำหรับการดาวน์โหลดโดยใช้การปรับการนำส่งให้เหมาะสมเท่านั้น

- **BytesFromHttp -**    ไบต์จาก http เฉพาะสำหรับการดาวน์โหลดโดยใช้การปรับการนำส่งให้เหมาะสมเท่านั้น

- **ByteFromInternetPeers -**   ไบต์จากเพียร์อินเทอร์เน็ต เฉพาะสำหรับการดาวน์โหลดโดยใช้การปรับการนำส่งให้เหมาะสมเท่านั้น 

- **BytesFromLanPeers -**   ไบต์จากเพียร์กลุ่ม LAN เฉพาะสำหรับการดาวน์โหลดโดยใช้การปรับการนำส่งให้เหมาะสมเท่านั้น 

- **CancelledJobs -**    จำนวนคำขอที่ถูกยกเลิกในเซสชัน

- **Connected -**   ว่าเชื่อมต่อกับแหล่งที่มาหรือไม่
...
รายงานผลลัพธ์ความพยายามในการติดตั้งแบบตั้งแต่ต้นจนจบ
 ...
 - **ErrorType –**  สตริงที่อธิบายถึงประเภทข้อผิดพลาดที่ไม่สามารถดำเนินการได้

 - **ExitCode –**   ค่าจำนวนเต็มที่เชื่อมโยงกับผลลัพธ์ของการเรียกใช้ bootstrapper เพื่อบ่งชี้ความสำเร็จเมื่อเทียบกับบางชนิดความล้มเหลว
...
- **BitField –**    ค่าจำนวนเต็มของอาร์กิวเมนต์ BitField ซึ่งบอกเราว่ามีการขอตัวเลือกการติดตั้ง/อัปเดตอย่างชัดเจนหรือไม่ (รายเดือน, Insider ที่อดใจรอได้, Insider ที่เร็วก่อนใคร, รายครึ่งปี, รายครึ่งปีแบบมีการกำหนดเป้าหมาย)

- **ChannelID –**   จำนวนเต็มแทนค่า enum ของตัวเลือกการอัปเดต/ ติดตั้งที่เลือก (รายเดือน, Insider ที่อดใจรอได้, Insider ที่เร็วก่อนใคร, รายครึ่งปี, รายครึ่งปีแบบมีการกำหนดเป้าหมาย, ไม่ถูกต้อง)

- **CMDMode –** สตริงที่เรียกง่ายที่สอดคล้องกับที่ตรวจพบการสลับโหมดโดยรวมในอาร์กิวเมนต์ cmd ส่งผ่านไปยัง exe
...
- **IsFireFlyInstalled –**  ค่าสถานะบูลีนที่บ่งชี้ว่าไคลเอ็นต์ RTM C2R ของ Office 2013 ตอนนี้ติดตั้งแล้วหรือไม่
...
- **Origin –**  ค่าสตริงที่บอกให้เราทราบว่าควรใช้จุดเริ่มต้นที่สนับสนุนใด (เปอร์โตริโก [PR], สิงคโปร์ [SG], ดับลิน [DB]) สำหรับการสตรีมการติดตั้งเริ่มต้น

- **PlatformFromLink –**    สตริงที่บ่งชี้ x86|x64|จำนวนบิตค่าเริ่มต้นที่ร้องขอของ Office ที่ร้องขอจากบริการติดตั้ง C2R

- **PlatformOfExistingInstallation –**  สตริงที่บ่งชี้ว่า x86 กับ X64 Office ได้รับการติดตั้งบนอุปกรณ์แล้วหรือไม่

- **PlatformToInstall –**   สตริงที่บ่งชี้การตัดสินใจขั้นสุดท้ายว่าควรจะติดตั้ง x86 หรือ X64 Office ความเป็นไปได้คือ: autorun, กำหนดค่า, ผู้บริโภค, ดาวน์โหลด, วิธีใช้, ตัวสร้างแพคเกจ
...
- **ShouldActivate –**  บูลีนที่บ่งชี้ว่าผู้ดูแลระบบ IT ร้องขอความพยายามเปิดใช้งานการอนุญาตการให้สิทธิ์การใช้งานอัตโนมัติใน configuration.xml หรือไม่
...
- **ErrorCode –**   ตัวเลขจำนวนเต็มที่เกี่ยวข้องกับข้อผิดพลาดที่ไม่สามารถดำเนินการได้
...
- **PlatformToInstall –**   สตริงที่บ่งชี้การตัดสินใจขั้นสุดท้ายว่าควรจะติดตั้ง x86 หรือ X64 Office
...
- **AvailableClientVersionText –**  ค่าสตริงของไคลเอ็นต์ C2R เวอร์ชัน "16.0.xxxxx.yyyyy" ที่พบใน Version Descriptor XML ซึ่งใช้ในการพิจารณาว่าควรจะอัปเดตไคลเอ็นต์ C2R ที่ติดตั้งอยู่ในปัจจุบันหรือไม่
...
- **DeliveryMechanism –**   guid "FFNRoot" ถูกดึงมาจาก Version Descriptor XML (ประทับโดย RDX) ซึ่งจะบอกเราว่าผู้ชม/แชนเนลใดที่มีแหล่งที่มาของการสร้าง

- **DownloadC2RClientAction –** "true" หากงาน DownloadC2RClientAction มีกำหนดการให้เรียกใช้ระหว่างการติดตั้งนี้
...
- **Result** - ค่าสถานะรหัสข้อผิดพลาดที่เป็นตัวเลขที่ส่งกลับโดย API การเรียกใช้บริการเว็บ Office

### <a name="officeserviceabilitymanagerwebservicefailure"></a>Office.ServiceabilityManager.WebserviceFailure

เหตุการณ์นี้ถูกบันทึกเมื่อใดก็ตามที่การเรียกบริการเว็บภายใน Add-on สินค้าคงคลังของตัวจัดการความสามารถในการให้บริการแบบคลิก-ทู-รันนั้นล้มเหลว
...
- **ConfigParam** - การกำหนดค่าสำหรับค่าที่ถูกเข้าถึง
...
การวัดและส่งข้อมูลทางไกลจะติดตามผลลัพธ์ของการเรียกใช้บริการแลก PIN

เขตข้อมูลต่อไปนี้จะมีการรวบรวม:

- **ClientTransactionId** - รหัสเฉพาะสำหรับการเรียกใช้บริการ

- **ErrorCategory** - ข้อผิดพลาดแต่ละชนิดอาจอยู่ในประเภทที่เข้าใจง่ายมากกว่านี้ เช่น "สามารถลองใหม่ได้"

- **ErrorType** - เหตุผลของความล้มเหลว เช่น "AlreadyRedeemedByOther"

- **InAFOFlow** - บูลีนที่บ่งชี้ว่าเราอยู่ในขั้นตอนการแลก AFO

- **StatusCode** - ผลลัพธ์คำเดียวของการเรียกใช้บริการ เช่น "สร้างแล้ว"
...
- **UserDismissed** - การดำเนินการนี้จะบอกว่าผู้ใช้ยกเลิกกล่องโต้ตอบ และจะอยู่ในโหมดฟังก์ชันการทำงานที่ผ่อนผันหรือลดลงเนื่องจากผู้ใช้ไม่ได้เลือกที่จะซื้อ Office หรือรับรุ่นทดลองใช้หรือไม่
...
- **GetEntitlementsSucceeded** - บอกว่าการเรียกใช้ API บริการการให้สิทธิการใช้งาน Office เพื่อดึงข้อมูลการให้สิทธิ์ของผู้ใช้นั้นสำเร็จหรือไม่
...
- **SentOnDestruction** - นี่เป็นเพียงการให้ข้อมูล และบอกว่ามีการเพิ่มเหตุการณ์ลงในแผนที่ตัวจัดการการวัดและส่งข้อมูลทางไกลและไม่ได้ส่งอย่างชัดเจนหรือไม่
...
- **Tag** - บอกเราเกี่ยวกับขั้นตอนที่เราหยุดการค้นหาการรวม แท็กที่เป็นไปได้:
  ...
  - 0x0311380d  ข้อผิดพลาดที่สามารถลองได้อีกครั้ง (ปัญหาอินเทอร์เน็ต ข้อผิดพลาดที่ไม่รู้จัก)
  - 0x0311380e  ข้อผิดพลาดที่ไม่สามารถลองได้อีกครั้ง (ข้อเสนอการรวมหมดอายุ)
  - 0x0311380f  ข้อผิดพลาดอื่นๆ (ไม่สามารถให้สิทธิการใช้งานได้)
  - 0x03104111  ไม่สามารถถอดรหัส PIN ของ Office ได้ ซึ่งส่งมาพร้อมกับเขตข้อมูล PinValidationResult

- **WpkBindingFailure** - บอกเราเกี่ยวกับรหัสข้อผิดพลาดในการรับ PIN ของ Office ซึ่งผูกรวมกับ WPK ของเครื่อง

### <a name="officelicensingtelemetryflowshowafodialogs"></a>Office.Licensing.TelemetryFlow.ShowAFODialogs

หลังจากประสบความสำเร็จในการรับ PIN ของ Office ที่ถูกต้องซึ่งผูกรวมกับเครื่องที่มาพร้อมกับ Office เราจะแสดงกล่องโต้ตอบการลงชื่อเข้าใช้หรือกล่องการแลกใช้ให้ผู้ใช้  เมื่อมีการแลก PIN เราจะแสดงกล่องโต้ตอบ EULA  ในฐานะส่วนหนึ่งของการทำให้ฟีเจอร์ AFO ทันสมัย เราได้รีเฟรชกล่องโต้ตอบสองกล่องเพื่อแสดงข้อมูลเพิ่มเติมเกี่ยวกับผลิตภัณฑ์ Office ที่มาพร้อมกับเครื่อง  การวัดและส่งข้อมูลทางไกลนี้จะติดตามว่าฟีเจอร์ของเราลดปัญหาของผู้ใช้ในการแลกใช้ผลิตภัณฑ์ของตนได้สำเร็จหรือไม่ โดยติดตามลำดับและจุดสิ้นสุดของกระบวนการแลกใช้ (ซึ่งกล่องโต้ตอบจะถูกยกเลิก)

เขตข้อมูลต่อไปนี้จะมีการรวบรวม:

- **ActionCreateAccount** - ผู้ใช้เลือกที่จะสร้างบัญชี

- **ActionSignIn** - ผู้ใช้เลือกที่จะลงชื่อเข้าใช้

- **DialogRedemption** - แสดงกล่องโต้ตอบการแลกใช้ AFO

- **DialogSignIn** - แสดงกล่องโต้ตอบการลงชื่อเข้าใช้ AFO

- **OExDetails** - รายละเอียดข้อผิดพลาดที่เราได้รับหลังจากกล่องโต้ตอบการลงชื่อเข้าใช้ของข้อมูลประจำตัวถูกยกเลิก

- **OExType** - ชนิดข้อผิดพลาดที่เราได้รับหลังจากกล่องโต้ตอบการลงชื่อเข้าใช้ของข้อมูลประจำตัวถูกยกเลิก

- **Tag** - บอกเราเกี่ยวกับขั้นตอนที่ผู้ใช้สิ้นสุดกระบวนการแลกใช้ AFO แท็กที่เป็นไปได้:
    - 0x0311380b    ผู้ใช้ยกเลิกกล่องโต้ตอบการลงชื่อเข้าใช้ของข้อมูลประจำตัวจากกล่องโต้ตอบการแลกใช้
    - 0x0311380c    ไม่สามารถโหลดข้อมูลประจำตัวโดยอัตโนมัติหลังจากที่ผู้ใช้ลงชื่อเข้าใช้จากกล่องโต้ตอบการแลกใช้
    - 0x03113810    ไม่สามารถโหลดข้อมูลประชากรของบัญชี (รหัสประเทศ ภาษา   สกุลเงิน ข้อเสนอรุ่นทดลองใช้ และการกำหนดลักษณะตลาด)
    - 0x03113805    ผู้ใช้ยกเลิกกล่องโต้ตอบการลงชื่อเข้าใช้ของข้อมูลประจำตัวจากกล่องโต้ตอบการลงชื่อเข้าใช้
...
- **UseInAppRedemption** - บอกว่าเรากำลังเก็บผู้ใช้ไว้ในแอปสำหรับการแลกใช้หรือส่งพวกเขาไปยังเว็บเพื่อแลก PIN ที่ดึงข้อมูลมา (กรอกข้อมูลไว้ล่วงหน้า)

- **UseModernAFO** - บอกว่าเรากำลังใช้ประสบการ์ใช้งาน AFO แบบใหม่หรือแบบเก่า
...
- **ActiveView** - บอก ID กล่องโต้ตอบที่แสดงให้ผู้ใช้

- **CurrentOOBEMode** - บอกโหมดการติดตั้งล่วงหน้า (โหมด OOBE เช่น AFO, OEM ฯลฯ)
...
- **HasConnectivity** - บอกว่าผู้ใช้มีการเชื่อมต่ออินเทอร์เน็ตหรือไม่ และในกรณีที่ไม่มี ผู้ใช้อาจต้องใช้สิทธิการใช้งานแบบผ่อนผันเป็นเวลาห้าวันหรืออาจอยู่ในโหมดฟังก์ชันการทำงานที่ลดลง

- **InAppTrialPurchase** - บอกว่าเวอร์ชันทดสอบเปิดใช้งานสำหรับการเปิดใช้ SDK ของการซื้อสินค้าจาก Store หรือไม่เพื่อบันทึก PI และซื้อรุ่นทดลองใช้จากภายในแอปพลิเคชัน
...
- **StoreErrorConditions** - บอกเงื่อนไขต่างๆ ที่อาจทำให้ SDK ของการซื้อสินค้าจาก Store ล้มเหลว

- **StoreErrorHResult** - บอกรหัสข้อผิดพลาดที่ส่งกลับจาก SDK ของการซื้อสินค้าจาก Store

- **StorePurchaseStatusResult** - บอกผลลัพธ์ของการเรียกใช้ SDK ของการซื้อสินค้าจาก Store และบอกว่าผู้ใช้ทำการสั่งซื้อหรือไม่ ซึ่งจะช่วยกำหนดว่าผู้ใช้ควรได้รับสิทธิการใช้งานในการใช้ Office หรือไม่

- **Tag** - ใช้เพื่อบอกตำแหน่งในรหัสที่เหตุการณ์ถูกส่งมา

- **UserSignedInExplicitly** - บอกว่าผู้ใช้ลงชื่อเข้าใช้อย่างชัดเจนในกรณีใด เราจะเปลี่ยนเส้นทางผู้ใช้ไปยังเว็บสำหรับรุ่นทดลองใช้
...
เหตุการณ์นี้แสดงว่ามีความล้มเหลวในขณะตรวจสอบความถูกต้องของการเซ็นชื่อในโค้ดในไฟล์เอกสารประกอบการอัปเดตที่เกิดขึ้น  เอกสารประกอบใดๆ ที่ล้มเหลวในการตรวจสอบการเซ็นชื่อในโค้ดควรถือว่าไม่ถูกต้อง
...
- **Payload** - มีชื่อไฟล์แค็ตตาล็อกที่มีลายเซ็นไม่ถูกต้อง ข้อความแบบคงที่ต่างๆ จะอธิบายเงื่อนไขข้อผิดพลาดแตกต่างกันไป
...
เหตุการณ์นี้บันทึกปัญหาเกี่ยวกับการติดตั้งบนลอกแบบ (ได้แก่ เราไม่สามารถเชื่อมต่อกับตัวช่วยเหลือเพื่อใช้การอัปเดต หรือเราเชื่อมต่อแต่ตัวช่วยเหลือไม่สามารถใช้การอัปเดตได้) หากเราได้รับบันทึกที่มีการรายงาน ย่อมหมายถึงการติดตั้งบนลอกแบบล้มเหลวและตอนนี้จะต้องย้อนกลับไปใช้การอัปเดตในตัว
...
เหตุการณ์นี้แสดงว่ากระบวนการตรวจสอบการอัปเดตถูกยกเลิก (โดยผู้ใช้หรือโดยระบบ) เราใช้เหตุการณ์นี้เพื่อให้แน่ใจว่ามีการเสนอการอัปเดตอย่างถูกต้อง ปรับการรองรับบริการให้เหมาะสม และนิยามความถี่ในการตรวจสอบการอัปเดตของเรา นอกจากนี้เรายังต้องการปรับจังหวะการเผยแพร่ของเราให้เหมาะสมตามความคาดหวังของผู้ใช้ในการอัปเดต
...
เหตุการณ์นี้แสดงว่ากระบวนการตรวจสอบการอัปเดตถูกยกเลิกโดยผู้ใช้  เราใช้เหตุการณ์นี้เพื่อให้แน่ใจว่ามีการเสนอการอัปเดตอย่างถูกต้อง ปรับการรองรับบริการให้เหมาะสม และนิยามความถี่ในการตรวจสอบการอัปเดตของเรา นอกจากนี้เรายังต้องการปรับจังหวะการเผยแพร่ของเราให้เหมาะสมตามความคาดหวังของผู้ใช้ในการอัปเดต
...
เหตุการณ์นี้แสดงว่าผู้ใช้ยกเลิกหลังจากที่เราแสดงแผ่นงานการอัปเดตที่จัดทำรายการอัปเดต เราใช้เหตุการณ์นี้เพื่ออธิบายเหตุผลในการไม่อัปเดต (คือผู้ใช้ยกเลิกด้วยความเต็มใจ) เราใช้เหตุการณ์นี้เพื่อให้มั่นใจว่ากระบวนการอัปเดตทำงานได้ตามที่คาดหวังและเพื่อช่วยแก้ไขข้อผิดพลาด
...
- **Payload** - มีชื่อของการอัปเดตที่กำลังดาวน์โหลดและข้อผิดพลาดที่สังเกต
...
- **Payload** - มี OSStatus (รหัสสถานะของ Apple) ที่แสดงสถานะการเปิดใช้
...
เหตุการณ์นี้บันทึกหากแอปทั้งหมดปิดก่อนการติดตั้ง เราใช้เหตุการณ์นี้เพื่อให้มั่นใจว่ากระบวนการอัปเดตทำงานได้ตามที่คาดหวังและเพื่อช่วยแก้ไขข้อผิดพลาด
...
- **Payload** - มีตัวระบุที่ใช้ในการติดตามกิจกรรมการอัปเดตและชื่อแอปพลิเคชันที่เปิดใช้
...
- **Payload** - มีตัวระบุที่ใช้ในการติดตามกิจกรรมการอัปเดตและ ID กลุ่มแอปพลิเคชัน ซึ่งอาจมีสตริงข้อผิดพลาดหาก Microsoft Autoupdate กำหนดว่าแอปพลิเคชันยังคงทำงานอยู่แม้ว่าจะได้รับเหตุการณ์การสิ้นสุด
...
เหตุการณ์นี้บันทึกสถานะของสถานะของเดมอน Microsoft AutoUpdate เราใช้เหตุการณ์นี้เพื่อให้มั่นใจว่ากระบวนการอัปเดตทำงานได้ตามที่คาดหวังและเพื่อช่วยแก้ไขข้อผิดพลาด
...
- **Payload** - มีการบ่งชี้ว่ามีคอมโพเนนต์เดมอนอยู่ในตำแหน่งที่คาดหวังหรือไม่และมีการเซ็นชื่อในโค้ดหรือไม่
...
เหตุการณ์นี้บันทึกสถานะของสถานะของเครื่องมือตัวช่วยเหลือ Microsoft AutoUpdate เราใช้เหตุการณ์นี้เพื่อให้มั่นใจว่ากระบวนการอัปเดตทำงานได้ตามที่คาดหวังและเพื่อช่วยแก้ไขข้อผิดพลาด
...
- **Payload** - ข้อความบ่งชี้ความสำเร็จของการดำเนินการ
...
- **Payload** - มีรายการ ID แอปพลิเคชันที่จะอัปเดต
...
เหตุการณ์นี้บันทึกการตอบสนองของผู้ใช้ต่อกล่องโต้ตอบการเลือกรับสำหรับการลงทะเบียนในการอัปเดตแบบไม่แจ้งให้ทราบ เราใช้เหตุการณ์นี้เพื่อให้มั่นใจว่ากระบวนการอัปเดตทำงานได้ตามที่คาดหวังและเพื่อช่วยแก้ไขข้อผิดพลาด
...
เราสามารถกรองการอัปเดตผ่านบริการ MAU เฉพาะเมื่อการอัปเดตที่เสนอนั้นไม่นานกว่าจำนวนวันที่กำหนด ตอนนี้เราบันทึกว่าเราไม่สามารถดึงวันที่จากเมตาดาต้าของแอปได้ เราใช้เหตุการณ์นี้เพื่อให้มั่นใจว่ากระบวนการอัปเดตทำงานได้ตามที่คาดหวังและเพื่อช่วยแก้ไขข้อผิดพลาด
...
เราสามารถกรองการอัปเดตผ่านบริการ MAU เฉพาะเมื่อการอัปเดตที่เสนอนั้นไม่นานกว่าจำนวนวันที่กำหนด ที่นี่เราบันทึกวันที่หายไปจากเมตาดาต้าของแอป เราใช้เหตุการณ์นี้เพื่อให้มั่นใจว่ากระบวนการอัปเดตทำงานได้ตามที่คาดหวังและเพื่อช่วยแก้ไขข้อผิดพลาด
...
เราสามารถกรองการอัปเดตผ่านบริการ MAU เฉพาะเมื่อการอัปเดตที่เสนอนั้นไม่นานกว่าจำนวนวันที่กำหนด ตอนนี้เราบันทึกบริการจะถูกเลี่ยงผ่านเนื่องจากวันที่อัปเดตเก่า เราใช้เหตุการณ์นี้เพื่อให้มั่นใจว่ากระบวนการอัปเดตทำงานได้ตามที่คาดหวังและเพื่อช่วยแก้ไขข้อผิดพลาด
...
เขตข้อมูลต่อไปนี้จะมีการรวบรวม:
  ...
  - **HexCrashTag-** ตัวระบุที่ไม่ซ้ำกันสำหรับรหัสของการหยุดทำงาน
  ...
  - **UninitLibletId – ** ตัวระบุที่ไม่ซ้ำกันสำหรับคอมโพเนนต์ที่ล้มเหลวของการหยุดทำงาน
