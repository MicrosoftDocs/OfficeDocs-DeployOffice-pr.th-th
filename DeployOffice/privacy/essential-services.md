...
เขตข้อมูลต่อไปนี้จะมีการรวบรวม:
  ...
  - **Scenarioname** – ชื่อของสถานการณ์สมมติที่เหตุการณ์การรับรองความถูกต้องนี้เป็นของ
...
เมตาดาต้าตามเซสชันเมื่อ Paywall UI ปรากฏให้ผู้ใช้เห็น Microsoft ใช้ข้อมูลนี้เพื่อรับการเดินทางของผู้ใช้ และทำความเข้าใจอุปกรณ์และเวอร์ชัน OS ที่ผู้ใช้กำลังใช้งาน เพื่อช่วยในการตัดสินใจเกี่ยวกับการลงทุนเพื่อปรับปรุงประสบการณ์ในพื้นที่เหล่านี้
