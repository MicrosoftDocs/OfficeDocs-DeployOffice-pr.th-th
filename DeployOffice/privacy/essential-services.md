...
เขตข้อมูลต่อไปนี้จะมีการรวบรวม:
  ...
  - **Data\_Sku** - SKU ที่ติดตั้งแล้ว เช่น Office 365 ProPlus.en-us
...
- **ChannelID –**    จำนวนเต็มแทนค่า enum ของตัวเลือกการอัปเดต/ การติดตั้งที่เลือก (รายเดือน, Insider ที่อดใจรอได้, Insider ที่เร็วก่อนใคร, รายครึ่งปี, รายครึ่งปีแบบมีการกำหนดเป้าหมาย, ไม่ถูกต้อง)
