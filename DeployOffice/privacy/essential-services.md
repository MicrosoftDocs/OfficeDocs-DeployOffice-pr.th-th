...
เหตุการณ์นี้จะบันทึกข้อมูลที่ช่วยในการตรวจสอบสถานภาพของคอมโพเนนต์ Dime ข้อมูลนี้ใช้ในการตรวจสอบและการแจ้งเตือนเกี่ยวกับสถานภาพของโฟลว์การสั่งซื้อ Dime เพื่อให้แน่ใจว่าทำงานได้ตามที่คาดไว้ 
...
- **Data_SDX_AssetId** - ID แอสเซทของเนื้อหาการโฮสต์บริการที่ส่งมอบประสบการณ์

- **Data_SDX_BrowserToken** - โทเค็นของเบราว์เซอร์

- **Data_SDX_HostJsVersion** - เวอร์ชันไลบรารี JavaScript

- **Data_SDX_Id** - ID บริการที่ส่งมอบประสบการณ์

- **Data_SDX_InstanceId** - ID อินสแตนซ์ของ SDX

- **Data_SDX_MarketplaceType** - ประเภท SDX Marketplace

- **Data_SDX_OfficeJsVersion** - เวอร์ชัน Office JS

- **Data_SDX_SessionId** - ID เซสชันของ SDX

- **Data_SDX_Version** - เวอร์ชัน SDX
