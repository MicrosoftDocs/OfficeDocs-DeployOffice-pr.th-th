...
เหตุการณ์นี้ถูกบันทึกไว้เมื่อพบบัญชีที่มีโทเค็นรีเฟรชที่ถูกต้องในรายการบัญชีที่จัดหาโดย TokenSharingManager สถานการณ์สมมตินี้มีไว้สำหรับการลงชื่อเข้าระบบครั้งเดียว (SSO) เท่านั้น
...
เหตุการณ์นี้ถูกบันทึกเมื่อมีข้อผิดพลาดเมื่อพยายามรับโทเค็นรีเฟรชสำหรับบัญชีในรายการบัญชีที่จัดหาโดย TokenSharingManager สถานการณ์สมมตินี้มีไว้สำหรับการลงชื่อเข้าระบบครั้งเดียว (SSO) เท่านั้น
...
การตั้งค่า Office และข้อมูลสรุปรายการที่รวบรวมไว้เมื่อตัวติดตั้ง Office กำลังวางไฟล์ที่ดาวน์โหลดใหม่ ใช้เพื่อวัดความสำเร็จ / ความล้มเหลวของการติดตั้ง Office
...
การตั้งค่า Office และข้อมูลสรุปรายการที่รวบรวมไว้เมื่อตัวติดตั้ง Office กำลังตัดสินใจว่าจะต้องดาวน์โหลดไฟล์ใด ใช้เพื่อวัดความสำเร็จ / ความล้มเหลวของการติดตั้ง Office
...
การตั้งค่า Office และข้อมูลสรุปรายการที่รวบรวมไว้เมื่อตัวติดตั้ง Office กำลังติดตั้งสิทธิการใช้งานและการตั้งค่ารีจิสทรี ใช้เพื่อวัดความสำเร็จ / ความล้มเหลวของการติดตั้ง Office
...
การตั้งค่า Office และข้อมูลสรุปรายการที่รวบรวมไว้เมื่อตัวติดตั้ง Office กำลังติดตั้งฟอนต์ ใช้เพื่อวัดความสำเร็จ / ความล้มเหลวของการติดตั้ง Office
...
การตั้งค่า Office และข้อมูลสรุปรายการที่รวบรวมไว้เมื่อตัวติดตั้ง Office กำลังสร้างการตั้งค่าเพื่อให้การอัปเดตทำงานได้ตามปกติ ใช้เพื่อวัดความสำเร็จ / ความล้มเหลวของการติดตั้ง Office
...
การตั้งค่า Office และข้อมูลสรุปรายการที่รวบรวมไว้เมื่อตัวติดตั้ง Office กำลังสิ้นสุดการติดตั้ง การปักหมุดทางลัด และการสร้างการตั้งค่ารีจิสทรีขั้นสุดท้าย ใช้เพื่อวัดความสำเร็จ / ความล้มเหลวของการติดตั้ง Office
...
การตั้งค่า Office และข้อมูลสรุปรายการที่รวบรวมไว้เมื่อตัวติดตั้ง Office กำลังโยกย้ายการตั้งค่าจาก Office เวอร์ชันที่เก่ากว่า ใช้เพื่อวัดความสำเร็จ / ความล้มเหลวของการติดตั้ง Office
...
การตั้งค่า Office และข้อมูลสรุปรายการที่รวบรวมไว้เมื่อตัวติดตั้ง Office กำลังเผยแพร่รีจิสทรีเสมือนสำหรับชั้นการจำลองเสมือน AppV ใช้เพื่อวัดความสำเร็จ / ความล้มเหลวของการติดตั้ง Office
...
การตั้งค่า Office และข้อมูลสรุปรายการที่รวบรวมไว้เมื่อตัวติดตั้ง Office กำลังดาวน์โหลดไฟล์ใหม่สำหรับ Office ใช้เพื่อวัดความสำเร็จ / ความล้มเหลวของการติดตั้ง Office
...
การตั้งค่า Office และข้อมูลสรุปรายการที่รวบรวมไว้เมื่อตัวติดตั้ง Office กำลังถอนการติดตั้ง Office เวอร์ชันก่อนหน้าจาก Store ใช้เพื่อวัดความสำเร็จ / ความล้มเหลวของการติดตั้ง Office
...
การตั้งค่า Office และข้อมูลสรุปรายการที่รวบรวมไว้เมื่อไคลเอ็นต์ซ่อมแซม Office ดาวน์โหลดไคลเอ็นต์คลิก-ทู-รันเวอร์ชันล่าสุดเพื่อเตรียมคอมพิวเตอร์สำหรับการถอนการติดตั้งและติดตั้งใหม่ ใช้เพื่อวัดความสำเร็จ / ความล้มเหลวของการติดตั้ง Office
...
การตั้งค่า Office และข้อมูลสรุปรายการที่รวบรวมไว้เมื่อไคลเอ็นต์ซ่อมแซม Office พยายามซ่อมแซมรายการรีจิสทรีที่มีปัญหาที่ทราบแล้ว ใช้เพื่อวัดความสำเร็จ / ความล้มเหลวของการติดตั้ง Office
...
การตั้งค่า Office และข้อมูลสรุปรายการที่รวบรวมไว้เมื่อไคลเอ็นต์ซ่อมแซม Office นำ Office ออกจากอุปกรณ์เพื่อเตรียมพร้อมสำหรับการติดตั้งใหม่เมื่อทำการซ่อมแซม ใช้เพื่อวัดความสำเร็จ / ความล้มเหลวของการติดตั้ง Office
...
การตั้งค่า Office และข้อมูลสรุปรายการที่รวบรวมไว้เมื่อไคลเอ็นต์คลิก-ทู-รันอัปเดตสิทธิการใช้งานเมื่อจำเป็น ใช้เพื่อวัดความสำเร็จ / ความล้มเหลวของการอัปเดต Office
...
การตั้งค่า Office และข้อมูลสรุปรายการที่รวบรวมไว้เมื่อไคลเอ็นต์คลิก-ทู-รันปิดแอปที่กำลังทำงานอยู่หากจำเป็นและติดตั้งไฟล์ใหม่ที่ดาวน์โหลดมา ใช้เพื่อวัดความสำเร็จ / ความล้มเหลวของการติดตั้ง Office
...
การตั้งค่า Office และข้อมูลสรุปรายการที่รวบรวมไว้เมื่อไคลเอ็นต์คลิก-ทู-รันตรวจสอบว่ามีการอัปเดตใหม่ที่พร้อมใช้งานหรือไม่ ใช้เพื่อวัดความสำเร็จ / ความล้มเหลวของการอัปเดต Office
...
การตั้งค่า Office และข้อมูลสรุปรายการที่รวบรวมไว้เมื่อไคลเอ็นต์คลิก-ทู-รันกำลังดาวน์โหลดการอัปเดตใหม่ ใช้เพื่อวัดความสำเร็จ / ความล้มเหลวของการอัปเดต Office
...
การตั้งค่า Office และข้อมูลสรุปรายการที่รวบรวมไว้เมื่อไคลเอ็นต์คลิก-ทู-รันกำลังล้างข้อมูลจากการอัปเดต และคืนค่าแอปที่เปิดไว้ก่อนหน้านี้ ใช้เพื่อวัดความสำเร็จ / ความล้มเหลวของการติดตั้ง Office
...
การวัดและส่งข้อมูลทางไกลสำหรับการใช้งานที่สำคัญเมื่อแสดงการควบคุม Paywall แก่ผู้ใช้ ใช้เพื่อทำความเข้าใจประสบการณ์การซื้อในแอปสำหรับผู้ใช้และปรับให้เหมาะสมสำหรับเวอร์ชันในอนาคต
...
เหตุการณ์นี้จะถูกใช้เป็นสัญญาณเพื่อบอกเราว่าประสบการณ์การซื้อในแอปกำลังถูกปิดจากผู้ใช้หรือแอปพลิเคชัน ข้อมูลที่ใช้ในการตรวจสอบและแจ้งเตือนเกี่ยวกับสถานภาพของโฟลว์การสั่งซื้อในแอปเพื่อให้แน่ใจว่าทำงานได้ตามที่คาดไว้  
...
ข้อมูลนี้จะรวบรวมเมื่อเราแสดงกล่องโต้ตอบการหมดอายุแก่ผู้ใช้ที่ระบุว่าสิทธิการใช้งานของตนหมดอายุ การตรวจหาว่าผู้ใช้อยู่ในสถานะที่ดีและไม่พลาดฟังก์ชันการทำงานเป็นเรื่องสำคัญ โดยใช้สำหรับสถานภาพระบบและใช้สำหรับวัตถุประสงค์ด้านการวินิจฉัยถ้าผู้ใช้รายงานปัญหาที่เกิดกับเครื่องของตน
...
ถ้าอุปกรณ์เข้าสู่โหมดลดฟังก์ชันการทำงาน เราจะส่งสัญญาณนี้เพื่อระบุว่าเครื่องอยู่ในสถานะที่ไม่สมบูรณ์ การตรวจหาว่าผู้ใช้อยู่ในสถานะที่ดีและไม่พลาดฟังก์ชันการทำงานเป็นเรื่องสำคัญ โดยใช้สำหรับสถานภาพระบบและใช้สำหรับวัตถุประสงค์ด้านการวินิจฉัยถ้าผู้ใช้รายงานปัญหาที่เกิดกับเครื่องของตน
...
ในกรณีที่เราพบปัญหาในเวิร์กโฟลว์การเปิดใช้งาน เราจะทริกเกอร์ตัวช่วยสร้างสิทธิการใช้งานแล้วส่งสัญญาณนี้เพื่อระบุสิ่งเดียวกัน การตรวจหาว่าผู้ใช้อยู่ในสถานะที่ดีและไม่พลาดฟังก์ชันการทำงานเป็นเรื่องสำคัญ โดยใช้สำหรับสถานภาพระบบและใช้สำหรับวัตถุประสงค์ด้านการวินิจฉัยถ้าผู้ใช้รายงานปัญหาที่เกิดกับเครื่องของตน
...
เหตุการณ์นี้จะถูกทริกเกอร์เมื่อเราแลกใช้ข้อเสนอของ Office สำหรับผู้ใช้ที่ซื้ออุปกรณ์ที่รวมอยู่กับการให้สิทธิ์ล่วงหน้าของ Office ของ OEM หรือได้ใส่คีย์ผลิตภัณฑ์แล้ว เราใช้ข้อมูลนี้เพื่อตรวจสอบสถานภาพของระบบและบริการ
...
ถ้าเราลงเอยด้วยการปิดหรือทำให้ Office หยุดทำงานเนื่องจากปัญหาด้านสิทธิการใช้งาน เราจะส่งสัญญาณนี้เพื่อระบุสิ่งเดียวกัน การตรวจหาว่าผู้ใช้อยู่ในสถานะที่ดีและไม่พลาดฟังก์ชันการทำงานเป็นเรื่องสำคัญ โดยใช้สำหรับสถานภาพระบบและใช้สำหรับวัตถุประสงค์ด้านการวินิจฉัยถ้าผู้ใช้รายงานปัญหาที่เกิดกับเครื่องของตน
...
ด้วยเหตุผลบางประการ ถ้าเราไม่สามารถให้สิทธิการใช้งานแก่ผู้ใช้ได้ เราจะติดตั้งคีย์ระยะผ่อนผันแล้วส่งสัญญาณนี้ที่มีความหมายออกไป การตรวจหาว่าผู้ใช้อยู่ในสถานะที่ดีและไม่พลาดฟังก์ชันการทำงานเป็นเรื่องสำคัญ โดยใช้สำหรับสถานภาพระบบและใช้สำหรับวัตถุประสงค์ด้านการวินิจฉัยถ้าผู้ใช้รายงานปัญหาที่เกิดกับเครื่องของตน
...
เหตุการณ์นี้จะถูกทริกเกอร์เมื่อเราแลกใช้ข้อเสนอของ Office สำหรับผู้ใช้ที่ซื้ออุปกรณ์ที่รวมอยู่กับการให้สิทธิ์ล่วงหน้าของ Office ของ OEM หรือได้ใส่คีย์ผลิตภัณฑ์แล้ว ข้อมูลนี้ใช้สำหรับข้อความบันทึกทั่วไป
...
เหตุการณ์นี้บ่งชี้ว่าเริ่มต้นงานการโคลนก่อนการอัปเดตแอปพลิเคชัน เราใช้เหตุการณ์นี้ร่วมกับเหตุการณ์ cloningtask.status เพื่อกำหนดปริมาณของความล้มเหลวในการโคลนเพื่อพิจารณาว่าควรจำกัดผลลัพธ์ฟีเจอร์การโคลนในแชนเนลผู้ชมที่แตกต่างกันหรือไม่
...
เหตุการณ์นี้แสดงว่าการตรวจสอบการอัปเดตส่งผลให้ไม่พบการอัปเดต เราใช้เหตุการณ์นี้เพื่อให้แน่ใจว่ามีการเสนอการอัปเดตอย่างถูกต้อง ปรับการรองรับบริการให้เหมาะสม และนิยามความถี่ในการตรวจสอบการอัปเดตของเรา นอกจากนี้เรายังต้องการปรับจังหวะการเผยแพร่ของเราให้เหมาะสมตามความคาดหวังของผู้ใช้ในการอัปเดต
...
เหตุการณ์นี้แสดงว่าดำเนินการตรวจสอบการอัปเดตแล้ว เราใช้เหตุการณ์นี้เพื่อให้แน่ใจว่ามีการเสนอการอัปเดตอย่างถูกต้อง ปรับการรองรับบริการให้เหมาะสม และระบุความถี่ในการตรวจสอบการอัปเดตของเรา นอกจากนี้เรายังต้องการปรับจังหวะการเผยแพร่ของเราให้เหมาะสมตามความคาดหวังของผู้ใช้ในการอัปเดต
...
เหตุการณ์นี้แสดงว่ามีการยกเลิกกระบวนการตรวจสอบการอัปเดตแล้ว (จากผู้ใช้หรือจากระบบ) เราใช้เหตุการณ์นี้เพื่อให้แน่ใจว่ามีการเสนอการอัปเดตอย่างถูกต้อง ปรับการรองรับบริการให้เหมาะสม และระบุความถี่ในการตรวจสอบการอัปเดตของเรา นอกจากนี้เรายังต้องการปรับจังหวะการเผยแพร่ของเราให้เหมาะสมตามความคาดหวังของผู้ใช้ในการอัปเดต
...
เหตุการณ์นี้แสดงว่ามีการยกเลิกกระบวนการตรวจสอบการอัปเดตจากผู้ใช้ เราใช้เหตุการณ์นี้เพื่อให้แน่ใจว่ามีการเสนอการอัปเดตอย่างถูกต้อง ปรับการรองรับบริการให้เหมาะสม และระบุความถี่ในการตรวจสอบการอัปเดตของเรา นอกจากนี้เรายังต้องการปรับจังหวะการเผยแพร่ของเราให้เหมาะสมตามความคาดหวังของผู้ใช้ในการอัปเดต
...
เหตุการณ์นี้แสดงว่าการเชื่อมต่อเครือข่ายสูญหายไปขณะดาวน์โหลดการอัปเดต เราใช้เหตุการณ์นี้เพื่อให้แน่ใจว่ากระบวนการอัปเดตจะทำงานตามที่คาดไว้ และช่วยแก้ไขข้อผิดพลาด
...
เหตุการณ์นี้แสดงว่าการเชื่อมต่อเครือข่ายสูญหายไปขณะดาวน์โหลดการอัปเดต นอกจากนี้ยังแสดงว่าผู้ใช้ได้รับการแจ้งให้ทราบเกี่ยวกับข้อผิดพลาดนี้ เราใช้เหตุการณ์นี้เพื่อให้แน่ใจว่ากระบวนการอัปเดตจะทำงานตามที่คาดไว้ และช่วยแก้ไขข้อผิดพลาด
...
เหตุการณ์นี้แสดงว่าการอัปเดตอย่างน้อยหนึ่งรายการจากชุดปัจจุบันล้มเหลว เราใช้เหตุการณ์นี้เพื่อให้แน่ใจว่ากระบวนการอัปเดตจะทำงานตามที่คาดไว้ และช่วยแก้ไขข้อผิดพลาด
...
เหตุการณ์นี้แสดงว่าการอัปเดตทั้งหมดจากชุดปัจจุบันเสร็จเรียบร้อยแล้ว เราใช้เหตุการณ์นี้เพื่อให้แน่ใจว่ากระบวนการอัปเดตจะทำงานตามที่คาดไว้ และช่วยแก้ไขข้อผิดพลาด
...
เหตุการณ์นี้แสดงว่ากระบวนการอัปเดตการดาวน์โหลดกลับมาทำงานต่อได้สำเร็จหลังจากหยุดชั่วคราว เราใช้เหตุการณ์นี้เพื่อให้แน่ใจว่ากระบวนการอัปเดตจะทำงานตามที่คาดไว้ และช่วยแก้ไขข้อผิดพลาด
...
เหตุการณ์นี้แสดงว่าอุปกรณ์ลงทะเบียนในโหมดอัปเดตอัตโนมัติ เราใช้เหตุการณ์นี้เพื่อให้แน่ใจว่ากระบวนการอัปเดตจะทำงานตามที่คาดไว้ และช่วยแก้ไขข้อผิดพลาด
...
เหตุการณ์นี้แสดงว่าอุปกรณ์ลงทะเบียนในโหมดอัปเดตด้วยตนเอง เราใช้เหตุการณ์นี้เพื่อให้แน่ใจว่ากระบวนการอัปเดตจะทำงานตามที่คาดไว้ และช่วยแก้ไขข้อผิดพลาด
...
เหตุการณ์นี้แสดงว่าผู้ใช้เลือกที่จะยกเลิกหรือละเว้นข้อความเตือนที่ให้ไว้ เราใช้เหตุการณ์นี้เพื่อให้แน่ใจว่ากระบวนการอัปเดตจะทำงานตามที่คาดไว้ และช่วยแก้ไขข้อผิดพลาด
...
เหตุการณ์นี้แสดงว่าผู้ใช้เลือกที่จะทำตามคำแนะนำการเตือนที่ให้ไว้ เราใช้เหตุการณ์นี้เพื่อให้แน่ใจว่ากระบวนการอัปเดตจะทำงานตามที่คาดไว้ และช่วยแก้ไขข้อผิดพลาด
...
เหตุการณ์นี้แสดงว่าการดาวน์โหลดสำหรับการอัปเดตเริ่มต้นผ่านหน้าต่างอัปเดต เราใช้เหตุการณ์นี้เพื่อให้แน่ใจว่ากระบวนการอัปเดตจะทำงานตามที่คาดไว้ และช่วยแก้ไขข้อผิดพลาด
...
เหตุการณ์นี้แสดงว่ามีข้อผิดพลาดที่ไม่คาดคิดเกิดขึ้น เราใช้เหตุการณ์นี้เพื่อให้แน่ใจว่ากระบวนการอัปเดตจะทำงานตามที่คาดไว้ และช่วยแก้ไขข้อผิดพลาด
...
เหตุการณ์นี้แสดงว่าการตรวจสอบความปลอดภัยของไฟล์ของเราล้มเหลว เราใช้เหตุการณ์นี้เพื่อให้แน่ใจว่ากระบวนการอัปเดตจะทำงานตามที่คาดไว้ และช่วยแก้ไขข้อผิดพลาด
...
เหตุการณ์นี้แสดงว่าการตรวจสอบลายเซ็นรหัสสำหรับแพคเกจล้มเหลว เราใช้เหตุการณ์นี้เพื่อให้แน่ใจว่ากระบวนการอัปเดตจะทำงานตามที่คาดไว้ และช่วยแก้ไขข้อผิดพลาด
...
เหตุการณ์นี้จะบันทึกเครื่องหมายที่ระบุว่ากระบวนการดาวน์โหลดเสร็จสมบูรณ์ด้วยตัวเอง เราใช้เหตุการณ์นี้เพื่อให้แน่ใจว่ากระบวนการอัปเดตจะทำงานตามที่คาดไว้ และช่วยแก้ไขข้อผิดพลาด
...
เหตุการณ์นี้จะบันทึกการอัปเดตที่จะถูกดาวน์โหลด เราใช้เหตุการณ์นี้เพื่อให้แน่ใจว่ากระบวนการอัปเดตจะทำงานตามที่คาดไว้ และช่วยแก้ไขข้อผิดพลาด
...
เหตุการณ์นี้แสดงว่ากระบวนการพื้นหลังจะตรวจหาการอัปเดต เราใช้เหตุการณ์นี้เพื่อให้แน่ใจว่ากระบวนการอัปเดตจะทำงานตามที่คาดไว้ และช่วยแก้ไขข้อผิดพลาด
...
เหตุการณ์นี้แสดงว่ากระบวนการพื้นหลังข้ามการอัปเดตเนื่องจากมีการเปิด MAU GUI ไว้ เราใช้เหตุการณ์นี้เพื่อให้แน่ใจว่ากระบวนการอัปเดตจะทำงานตามที่คาดไว้ และช่วยแก้ไขข้อผิดพลาด
...
เหตุการณ์นี้บ่งชี้ว่า Microsoft Auto Update (MAU) ส่งการแจ้งให้ทราบเกี่ยวกับการอัปเดตที่ค้างอยู่ เหตุการณ์นี้จะถูกใช้เพื่อกำหนดปริมาณของการอัปเดตที่เริ่มจากการแจ้งเตือนผู้ใช้และใช้เพื่อปรับปรุงประสบการณ์ใช้งานของผู้ใช้โดยการลดการขัดจังหวะผู้ใช้ในการเผยแพร่ในอนาคต
...
เหตุการณ์นี้จะบันทึกความล้มเหลวของ daemon ของ MAU ขณะพยายามเปิดใช้ เราใช้เหตุการณ์นี้เพื่อให้แน่ใจว่ากระบวนการอัปเดตจะทำงานตามที่คาดไว้ และช่วยแก้ไขข้อผิดพลาด
...
เหตุการณ์นี้บ่งชี้ว่า Microsoft Update Assistant จะเริ่มการอัปเดตแบบเงียบ เหตุการณ์นี้จะถูกใช้เพื่อกำหนดปริมาณของการอัปเดตที่จะถูกนำไปใช้โดยไม่มีการขัดจังหวะของผู้ใช้เพื่อช่วยในการปรับปรุงประสิทธิภาพประสบการณ์ใช้งานของผู้ใช้
...
เหตุการณ์นี้แสดงว่าผู้ใช้เลือกรับการอัปเดตแบบไม่แจ้ง เราใช้เหตุการณ์นี้เพื่อให้แน่ใจว่ากระบวนการอัปเดตจะทำงานตามที่คาดไว้ และช่วยแก้ไขข้อผิดพลาด
...
เหตุการณ์นี้บ่งชี้ว่ามีการข้ามการตรวจสอบการอัพเดทที่ถูกบังคับเนื่องจากแอปพลิเคชันที่เปิดอยู่ เราใช้เหตุการณ์นี้เพื่อให้แน่ใจว่ากระบวนการอัปเดตจะทำงานตามที่คาดไว้ และช่วยแก้ไขข้อผิดพลาด
...
เหตุการณ์นี้ระบุว่า MAU daemon สิ้นสุดตามปกติ เราใช้เหตุการณ์นี้เพื่อให้แน่ใจว่ากระบวนการอัปเดตจะทำงานตามที่คาดไว้ และช่วยแก้ไขข้อผิดพลาด
...
เหตุการณ์นี้ระบุว่า MAU daemon พบการอัปเดตที่พร้อมใช้งานเพื่อเสนอ เราใช้เหตุการณ์นี้เพื่อให้แน่ใจว่ากระบวนการอัปเดตจะทำงานตามที่คาดไว้ และช่วยแก้ไขข้อผิดพลาด
...
เหตุการณ์นี้จะบันทึกผลลัพธ์ของการเซ็นชื่อในโค้ดหลังจากใช้การอัปเดต เราใช้เหตุการณ์นี้เพื่อให้แน่ใจว่ากระบวนการอัปเดตจะทำงานตามที่คาดไว้ และช่วยแก้ไขข้อผิดพลาด
...
เหตุการณ์นี้แสดงว่ามีการดาวน์โหลดการอัปเดตแล้ว เราใช้เหตุการณ์นี้เพื่อให้แน่ใจว่ากระบวนการอัปเดตจะทำงานตามที่คาดไว้ และช่วยแก้ไขข้อผิดพลาด
...
เหตุการณ์นี้แสดงว่ามีความล้มเหลวเกิดขึ้นขณะดาวน์โหลดการอัปเดต เราใช้เหตุการณ์นี้เพื่อให้แน่ใจว่ากระบวนการอัปเดตจะทำงานตามที่คาดไว้ และช่วยแก้ไขข้อผิดพลาด
...
เหตุการณ์นี้แสดงว่ามีการพยายามติดตั้งการอัปเดต (เวอร์ชัน) ล้มเหลว เราใช้เหตุการณ์นี้เพื่อให้แน่ใจว่ากระบวนการอัปเดตจะทำงานตามที่คาดไว้ และช่วยแก้ไขข้อผิดพลาด
...
เหตุการณ์นี้แสดงว่าการอัปเดตทั้งหมดของชุดติดตั้งเสร็จสิ้นแล้ว เราใช้เหตุการณ์นี้เพื่อให้แน่ใจว่ากระบวนการอัปเดตจะทำงานตามที่คาดไว้ และช่วยแก้ไขข้อผิดพลาด
...
เหตุการณ์นี้แสดงว่ามีการติดตั้งการอัปเดตแต่ละรายการสำเร็จแล้ว เราใช้เหตุการณ์นี้เพื่อให้แน่ใจว่ากระบวนการอัปเดตจะทำงานตามที่คาดไว้ และช่วยแก้ไขข้อผิดพลาด
...
เหตุการณ์นี้แสดงว่ามีการเริ่มต้นการอัปเดตแต่ละรายการ เราใช้เหตุการณ์นี้เพื่อให้แน่ใจว่ากระบวนการอัปเดตจะทำงานตามที่คาดไว้ และช่วยแก้ไขข้อผิดพลาด
...
เหตุการณ์นี้แสดงว่าการอัปเดตที่ถูกบล็อกไม่ได้ถูกบล็อกอีกต่อไปแล้ว เราใช้เหตุการณ์นี้เพื่อให้แน่ใจว่ากระบวนการอัปเดตจะทำงานตามที่คาดไว้ และช่วยแก้ไขข้อผิดพลาด
...
เหตุการณ์นี้แสดงว่าการอัปเดตจะถูกจัดคิวสำหรับการติดตั้งแบบไม่แจ้งให้ทราบ เราใช้เหตุการณ์นี้เพื่อให้แน่ใจว่ากระบวนการอัปเดตจะทำงานตามที่คาดไว้ และช่วยแก้ไขข้อผิดพลาด
...
เหตุการณ์นี้จะบันทึกสถานะของไบนารี OS codesign เราใช้เหตุการณ์นี้เพื่อให้แน่ใจว่ากระบวนการอัปเดตจะทำงานตามที่คาดไว้ และช่วยแก้ไขข้อผิดพลาด
...
เหตุการณ์นี้จะบันทึกสถานะของ Microsoft AutoUpdate daemon เราใช้เหตุการณ์นี้เพื่อให้แน่ใจว่ากระบวนการอัปเดตจะทำงานตามที่คาดไว้ และช่วยแก้ไขข้อผิดพลาด
...
เหตุการณ์นี้จะบันทึกสถานะของเครื่องมือตัวช่วยเหลือ Microsoft AutoUpdate เราใช้เหตุการณ์นี้เพื่อให้แน่ใจว่ากระบวนการอัปเดตจะทำงานตามที่คาดไว้ และช่วยแก้ไขข้อผิดพลาด
...
เหตุการณ์นี้แสดงว่าการตรวจสอบการเซ็นชื่อในโค้ดล้มเหลวสำหรับการอัปเดตแอป เราใช้เหตุการณ์นี้เพื่อให้แน่ใจว่ากระบวนการอัปเดตจะทำงานตามที่คาดไว้ และช่วยแก้ไขข้อผิดพลาด
...
เหตุการณ์นี้แสดงว่าการตรวจสอบการเซ็นชื่อในโค้ดเริ่มต้นแล้วสำหรับการอัปเดตแอป เราใช้เหตุการณ์นี้เพื่อให้แน่ใจว่ากระบวนการอัปเดตจะทำงานตามที่คาดไว้ และช่วยแก้ไขข้อผิดพลาด
...
เหตุการณ์นี้แสดงว่าการตรวจสอบการเซ็นชื่อในโค้ดสำเร็จสำหรับการอัปเดตแอป เราใช้เหตุการณ์นี้เพื่อให้แน่ใจว่ากระบวนการอัปเดตจะทำงานตามที่คาดไว้ และช่วยแก้ไขข้อผิดพลาด
...
เหตุการณ์นี้แสดงว่าพบข้อผิดพลาดในระหว่างกระบวนการลองติดตั้งใหม่ เราใช้เหตุการณ์นี้เพื่อให้แน่ใจว่ากระบวนการอัปเดตจะทำงานตามที่คาดไว้ และช่วยแก้ไขข้อผิดพลาด
...
เหตุการณ์นี้จะบันทึกข้อผิดพลาดการติดต่อสื่อสารของกระบวนการภายใน (การติดต่อสื่อสารกับเครื่องมือตัวช่วยเหลือ MAU) เราใช้เหตุการณ์นี้เพื่อให้แน่ใจว่ากระบวนการอัปเดตจะทำงานตามที่คาดไว้ และช่วยแก้ไขข้อผิดพลาด
...
เหตุการณ์นี้บันทึกการลองอีกครั้งที่ไม่ได้ผล เราใช้เหตุการณ์นี้เพื่อให้แน่ใจว่ากระบวนการอัปเดตจะทำงานตามที่คาดไว้ และช่วยแก้ไขข้อผิดพลาด
...
เหตุการณ์นี้จะบันทึกการติดตั้งการอัปเดตที่เสร็จสมบูรณ์หลังจากการลองใหม่ เราใช้เหตุการณ์นี้เพื่อให้แน่ใจว่ากระบวนการอัปเดตจะทำงานตามที่คาดไว้ และช่วยแก้ไขข้อผิดพลาด
...
เหตุการณ์นี้จะบันทึกรายการการอัปเดตที่อยู่ในคิวซึ่งไม่สามารถใช้ได้ เราใช้เหตุการณ์นี้เพื่อให้แน่ใจว่ากระบวนการอัปเดตจะทำงานตามที่คาดไว้ และช่วยแก้ไขข้อผิดพลาด
...
เหตุการณ์นี้จะบันทึกรายการของการอัปเดตที่อยู่ในคิวที่ติดตั้งเสร็จสมบูรณ์แล้ว เราใช้เหตุการณ์นี้เพื่อให้แน่ใจว่ากระบวนการอัปเดตจะทำงานตามที่คาดไว้ และช่วยแก้ไขข้อผิดพลาด
...
เหตุการณ์นี้จะบันทึกรายการของการอัปเดตที่อยู่ในคิว เราใช้เหตุการณ์นี้เพื่อให้แน่ใจว่ากระบวนการอัปเดตจะทำงานตามที่คาดไว้ และช่วยแก้ไขข้อผิดพลาด
...
เหตุการณ์นี้จะบันทึกการตอบสนองของผู้ใช้ต่อกล่องโต้ตอบการเลือกเข้าร่วมสำหรับการลงทะเบียนการอัปเดตแบบไม่แจ้งให้ทราบ เราใช้เหตุการณ์นี้เพื่อให้แน่ใจว่ากระบวนการอัปเดตจะทำงานตามที่คาดไว้ และช่วยแก้ไขข้อผิดพลาด
...
เหตุการณ์นี้จะบันทึกเมื่อใดก็ตามที่คีย์รายการหายไปจากส่วนเสริม เราใช้เหตุการณ์นี้เพื่อให้แน่ใจว่ากระบวนการอัปเดตจะทำงานตามที่คาดไว้ และช่วยแก้ไขข้อผิดพลาด
...
บันทึกเหตุการณ์นี้จะพยายามลงทะเบียนแอปและผลลัพธ์/เหตุผล เราใช้เหตุการณ์นี้เพื่อให้แน่ใจว่ากระบวนการอัปเดตจะทำงานตามที่คาดไว้ และช่วยแก้ไขข้อผิดพลาด
...
เหตุการณ์นี้ระบุว่า Launch Agent กำลังโหลด เราใช้เหตุการณ์นี้เพื่อให้แน่ใจว่ากระบวนการอัปเดตจะทำงานตามที่คาดไว้ และช่วยแก้ไขข้อผิดพลาด
...
เหตุการณ์นี้จะบันทึกข้อผิดพลาดที่เกิดขึ้นขณะเข้าถึง CDN เราใช้เหตุการณ์นี้เพื่อให้แน่ใจว่ากระบวนการอัปเดตจะทำงานตามที่คาดไว้ และช่วยแก้ไขข้อผิดพลาด
...
เหตุการณ์นี้รายงานข้อผิดพลาดที่ระบุว่า ID แอปพลิเคชันที่ได้รับจากการตอบสนองของเว็บไม่ใช่รูปแบบที่คาดการณ์ไว้ เหตุการณ์นี้ใช้ในการตรวจสอบข้อผิดพลาดที่รายงาน
...
เหตุการณ์นี้จะบันทึกเมื่อใดก็ตามที่เราเริ่มการตรวจหาการอัปเดต เราใช้เหตุการณ์นี้เพื่อให้แน่ใจว่ากระบวนการอัปเดตจะทำงานตามที่คาดไว้ และช่วยแก้ไขข้อผิดพลาด
...
เราบันทึกทุกครั้งที่พบการตรวจสอบผลลัพธ์การอัปเดตในการอัปเดต เราใช้เหตุการณ์นี้เพื่อให้แน่ใจว่ากระบวนการอัปเดตจะทำงานตามที่คาดไว้ และช่วยแก้ไขข้อผิดพลาด
...
เหตุการณ์นี้แสดงว่าพบการอัปเดตสำหรับแอปและเกณฑ์พื้นฐาน เราใช้เหตุการณ์นี้เพื่อให้แน่ใจว่ากระบวนการอัปเดตจะทำงานตามที่คาดไว้ และช่วยแก้ไขข้อผิดพลาด
...
เหตุการณ์นี้แสดงว่าพบการอัปเดตและอยู่ระหว่างการติดตั้ง เราใช้เหตุการณ์นี้เพื่อให้แน่ใจว่ากระบวนการอัปเดตจะทำงานตามที่คาดไว้ และช่วยแก้ไขข้อผิดพลาด
...
เหตุการณ์นี้แสดงว่าพบตัวเลือกการอัปเดตแบบไม่แจ้ง เราใช้เหตุการณ์นี้เพื่อให้แน่ใจว่ากระบวนการอัปเดตจะทำงานตามที่คาดไว้ และช่วยแก้ไขข้อผิดพลาด
...
เหตุการณ์นี้จะบันทึกคำขอไปยังบริการ MAU เวลาการตอบสนอง และข้อผิดพลาด เราใช้เหตุการณ์นี้เพื่อให้แน่ใจว่ากระบวนการอัปเดตจะทำงานตามที่คาดไว้ และช่วยแก้ไขข้อผิดพลาด
...
เหตุการณ์นี้จะบันทึกผลลัพธ์การซิงค์ของส่วน ซึ่งใช้เพื่อค้นหาจำนวนเป้าหมายการซิงค์เฉพาะเมื่อคํานวณคะแนนการซิงค์ OneNote และยังใช้แดชบอร์ดประสิทธิภาพการซิงค์ที่ทันสมัยของ OneNote อีกด้วย
...
เมตริก DQ การควบคุมปริมาณ จำเป็นสำหรับความเชื่อมั่นในข้อมูลอื่นๆ ทั้งหมด
